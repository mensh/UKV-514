...
void MX_FSMC_Init(void)
{
  ...
  hnand1.Instance = ((FSMC_Bank2_3_TypeDef *) (((uint32_t)0xA0000000) + 0x0060));
   
  hnand1.Init.NandBank = ((uint32_t)0x00000010);
  hnand1.Init.Waitfeature = ((uint32_t)0x00000002);
  hnand1.Init.MemoryDataWidth = ((uint32_t)0x00000000);
  hnand1.Init.EccComputation = ((uint32_t)0x00000000);
  hnand1.Init.ECCPageSize = ((uint32_t)0x00000000);
  ...
  hnand2.Instance = ((FSMC_Bank2_3_TypeDef *) (((uint32_t)0xA0000000) + 0x0060));
   
  hnand2.Init.NandBank = ((uint32_t)0x00000100);
  hnand2.Init.Waitfeature = ((uint32_t)0x00000002);
  hnand2.Init.MemoryDataWidth = ((uint32_t)0x00000000);
  hnand2.Init.EccComputation = ((uint32_t)0x00000000);
  hnand2.Init.ECCPageSize = ((uint32_t)0x00000000);
...
static void HAL_FSMC_MspInit(void){
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x0800)|((uint16_t)0x1000)|((uint16_t)0x4000)|((uint16_t)0x8000)
                          |((uint16_t)0x0001)|((uint16_t)0x0002)|((uint16_t)0x0010)|((uint16_t)0x0020)
                          |((uint16_t)0x0080);
  GPIO_InitStruct.Mode = ((uint32_t)0x00000002);
  GPIO_InitStruct.Pull = ((uint32_t)0x00000000);
  GPIO_InitStruct.Speed = ((uint32_t)0x00000000);
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x0040)|((uint16_t)0x0080)|((uint16_t)0x0200);
  GPIO_InitStruct.Mode = ((uint32_t)0x00000002);
  GPIO_InitStruct.Pull = ((uint32_t)0x00000000);
  GPIO_InitStruct.Speed = ((uint32_t)0x00000000);
  GPIO_InitStruct.Alternate = ((uint8_t)0xC);
...
static void HAL_FSMC_MspDeInit(void){
  ...
  HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000)), ((uint16_t)0x0080)|((uint16_t)0x0100)|((uint16_t)0x0200)|((uint16_t)0x0400));

  HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), ((uint16_t)0x0800)|((uint16_t)0x1000)|((uint16_t)0x4000)|((uint16_t)0x8000)
                          |((uint16_t)0x0001)|((uint16_t)0x0002)|((uint16_t)0x0010)|((uint16_t)0x0020)
                          |((uint16_t)0x0080));

  HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1800)), ((uint16_t)0x0040)|((uint16_t)0x0080)|((uint16_t)0x0200));

...
#line 68 "..\\..\\Drivers\\STM32F2xx_HAL_Driver\\Src\\stm32f2xx_hal_flash_ex.c"
...
void HAL_FLASHEx_OBGetConfig(FLASH_OBProgramInitTypeDef *pOBInit)
{
  pOBInit->OptionType = ((uint32_t)0x01) | ((uint32_t)0x02) | ((uint32_t)0x04) | ((uint32_t)0x08);
...
void FLASH_Erase_Sector(uint32_t Sector, uint8_t VoltageRange)
{
  ...
  ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3C00))->CR |= tmp_psize;
  ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3C00))->CR &= ((uint32_t)0xFFFFFF07);
  ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3C00))->CR |= ((uint32_t)0x00000002) | (Sector << (__clz(__rbit(((uint32_t)0x000000F8)))));
  ((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3C00))->CR |= ((uint32_t)0x00010000);
}
...
static HAL_StatusTypeDef FLASH_OB_EnableWRP(uint32_t WRPSector)
{
  ...
  if(status == HAL_OK)
  { 
    *(volatile uint16_t*)((uint32_t)0x40023C16) &= (~WRPSector);  
  }
...
static HAL_StatusTypeDef FLASH_OB_DisableWRP(uint32_t WRPSector)
{
  ...
  if(status == HAL_OK)
  { 
    *(volatile uint16_t*)((uint32_t)0x40023C16) |= (uint16_t)WRPSector; 
  }
...
static HAL_StatusTypeDef FLASH_OB_UserConfig(uint8_t Iwdg, uint8_t Stop, uint8_t Stdby)
{
  ...
  {     
    ...
    *(volatile uint8_t *)((uint32_t)0x40023C14) = Iwdg | (uint8_t)(Stdby | (uint8_t)(Stop | ((uint8_t)optiontmp))); 
  }
...
static HAL_StatusTypeDef FLASH_OB_BOR_LevelConfig(uint8_t Level)
{
  ...
  *(volatile uint8_t *)((uint32_t)0x40023C14) |= Level;
...
static uint8_t FLASH_OB_GetUser(void)
{
  ...
  return ((uint8_t)(((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3C00))->OPTCR & 0xE0));
}

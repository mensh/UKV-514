...
#line 81 "..\\..\\Drivers\\STM32F2xx_HAL_Driver\\Src\\stm32f2xx_hal_spi.c"
...
HAL_StatusTypeDef HAL_SPI_Init(SPI_HandleTypeDef *hspi)
{
  ...
  hspi->Instance->CR2 = (((hspi->Init.NSS >> 16) & ((uint32_t)0x00000004)) | hspi->Init.TIMode);
  ...
  hspi->Instance->I2SCFGR &= (uint32_t)(~((uint32_t)0x00000800));
...
HAL_StatusTypeDef HAL_SPI_Transmit(SPI_HandleTypeDef *hspi, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  ...
  if(hspi->State == HAL_SPI_STATE_READY)
  {
    ...
    {
      do{(hspi)->Instance ->CR1 &= (~((uint32_t)0x00002000)); (hspi)->Instance ->CR1 |= ((uint32_t)0x00002000);}while(0);
    }
    ...
    if(hspi->Init.DataSize == ((uint32_t)0x00000000))
    {
      ...
      while(hspi->TxXferCount > 0)
      {
        ...
        if(SPI_WaitOnFlagUntilTimeout(hspi, ((uint32_t)0x00000002), RESET, Timeout) != HAL_OK)
        { 
          return HAL_TIMEOUT;
        }
        hspi->Instance->DR = (*hspi->pTxBuffPtr++);
    ...
    if(SPI_WaitOnFlagUntilTimeout(hspi, ((uint32_t)0x00000080), SET, Timeout) != HAL_OK)
    { 
      hspi->ErrorCode |= HAL_SPI_ERROR_FLAG;
      return HAL_TIMEOUT;
    }
    ...
    {
      do{(hspi)->Instance ->DR; (hspi)->Instance ->SR;}while(0);
    }
  ...
  if(hspi->State == HAL_SPI_STATE_READY)
  {
    ...
    if(hspi->Init.DataSize == ((uint32_t)0x00000000))
    {
      while(hspi->RxXferCount > 1)
      {
        ...
        if(SPI_WaitOnFlagUntilTimeout(hspi, ((uint32_t)0x00000001), RESET, Timeout) != HAL_OK)
        { 
          return HAL_TIMEOUT;
        }
    ...
    tmp = ((((hspi)->Instance ->SR) & (((uint32_t)0x00000010))) == (((uint32_t)0x00000010)));
     
    if((hspi->Init.CRCCalculation == ((uint32_t)0x00002000)) && (tmp != RESET))
    {  
      hspi->ErrorCode |= HAL_SPI_ERROR_CRC;
...
HAL_StatusTypeDef HAL_SPI_TransmitReceive(SPI_HandleTypeDef *hspi, uint8_t *pTxData, uint8_t *pRxData, uint16_t Size, uint32_t Timeout)
{
  ...
  {
    if((pTxData == (void *) 0 ) || (pRxData == (void *) 0 ) || (Size == 0))
    {
      return  HAL_ERROR;
    }
    ...
    if(hspi->Init.DataSize == ((uint32_t)0x00000800))
    {
      hspi->Instance->DR = *((uint16_t*)hspi->pTxBuffPtr);
      hspi->pTxBuffPtr+=2;
      hspi->TxXferCount--;
...
HAL_StatusTypeDef HAL_SPI_Receive_IT(SPI_HandleTypeDef *hspi, uint8_t *pData, uint16_t Size)
{
  if(hspi->State == HAL_SPI_STATE_READY)
  {
    ...
    else if((hspi->Init.Direction == ((uint32_t)0x00000000)) && (hspi->Init.Mode == (((uint32_t)0x00000004) | ((uint32_t)0x00000100))))
    {
...
HAL_StatusTypeDef HAL_SPI_TransmitReceive_DMA(SPI_HandleTypeDef *hspi, uint8_t *pTxData, uint8_t *pRxData, uint16_t Size)
{
  ...
  if((tmpstate == HAL_SPI_STATE_READY) || (tmpstate == HAL_SPI_STATE_BUSY_RX))
  {
    ...
    hspi->hdmatx->XferCpltCallback = (void *) 0;
...
void HAL_SPI_IRQHandler(SPI_HandleTypeDef *hspi)
{
  ...
  tmp1 = ((((hspi)->Instance ->SR) & (((uint32_t)0x00000001))) == (((uint32_t)0x00000001)));
  tmp2 = ((((hspi)->Instance ->CR2 & (((uint32_t)0x00000040))) == (((uint32_t)0x00000040))) ? SET : RESET);
  tmp3 = ((((hspi)->Instance ->SR) & (((uint32_t)0x00000040))) == (((uint32_t)0x00000040)));
  ...
  tmp1 = ((((hspi)->Instance ->SR) & (((uint32_t)0x00000002))) == (((uint32_t)0x00000002)));
  tmp2 = ((((hspi)->Instance ->CR2 & (((uint32_t)0x00000080))) == (((uint32_t)0x00000080))) ? SET : RESET);
  ...
  if(((((hspi)->Instance ->CR2 & (((uint32_t)0x00000020))) == (((uint32_t)0x00000020))) ? SET : RESET) != RESET)
  {
     
    if(((((hspi)->Instance ->SR) & (((uint32_t)0x00000010))) == (((uint32_t)0x00000010))) != RESET)
    {
      hspi->ErrorCode |= HAL_SPI_ERROR_CRC;
      ((hspi)->Instance ->SR &= ~(((uint32_t)0x00000010)));
    }
     
    if(((((hspi)->Instance ->SR) & (((uint32_t)0x00000020))) == (((uint32_t)0x00000020))) != RESET)
    {
      hspi->ErrorCode |= HAL_SPI_ERROR_MODF;
      do{(hspi)->Instance ->SR; (hspi)->Instance ->CR1 &= (~((uint32_t)0x00000040));}while(0);
    }
...
static void SPI_TxCloseIRQHandler(SPI_HandleTypeDef *hspi)
{
  ...
  if(SPI_WaitOnFlagUntilTimeout(hspi, ((uint32_t)0x00000002), RESET, 10) != HAL_OK)
  {
    hspi->ErrorCode |= HAL_SPI_ERROR_FLAG;
  }
  ...
  if(((((hspi)->Instance ->CR2 & (((uint32_t)0x00000040))) == (((uint32_t)0x00000040))) ? SET : RESET) == RESET)
  {
    ((hspi)->Instance ->CR2 &= (~((((uint32_t)0x00000020)))));

     
    if(SPI_WaitOnFlagUntilTimeout(hspi, ((uint32_t)0x00000080), SET, 10) != HAL_OK)
    {
      hspi->ErrorCode |= HAL_SPI_ERROR_FLAG;
    }
...
static void SPI_RxCloseIRQHandler(SPI_HandleTypeDef *hspi)
{
  ...
  if(hspi->Init.CRCCalculation == ((uint32_t)0x00002000))
  {
    ...
    if(SPI_WaitOnFlagUntilTimeout(hspi, ((uint32_t)0x00000001), RESET, 10) != HAL_OK)
    {
      hspi->ErrorCode |= HAL_SPI_ERROR_FLAG;
    }
    ...
    if(SPI_WaitOnFlagUntilTimeout(hspi, ((uint32_t)0x00000001), SET, 10) != HAL_OK)
    {
      hspi->ErrorCode |= HAL_SPI_ERROR_FLAG;
    }
  ...
  if(((((hspi)->Instance ->CR2 & (((uint32_t)0x00000080))) == (((uint32_t)0x00000080))) ? SET : RESET) == RESET)
  {

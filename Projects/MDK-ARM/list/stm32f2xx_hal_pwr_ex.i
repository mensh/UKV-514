...
#line 44 "..\\..\\Drivers\\STM32F2xx_HAL_Driver\\Src\\stm32f2xx_hal_pwr_ex.c"
...
HAL_StatusTypeDef HAL_PWREx_EnableBkUpReg(void)
{
  ...
  *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x04) * 32) + (0x09 * 4)) = (uint32_t)ENABLE;

   
  timeout = HAL_GetTick() + 1000;
     
  while(((((PWR_TypeDef *) (((uint32_t)0x40000000) + 0x7000))->CSR & (((uint32_t)0x00000008))) == (((uint32_t)0x00000008))) == RESET)
  {
...
HAL_StatusTypeDef HAL_PWREx_DisableBkUpReg(void)
{
  ...
  *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x04) * 32) + (0x09 * 4)) = (uint32_t)DISABLE;
...
void HAL_PWREx_EnableFlashPowerDown(void)
{
  *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x00) * 32) + (0x09 * 4)) = (uint32_t)ENABLE;
}
...
void HAL_PWREx_DisableFlashPowerDown(void)
{
  *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x00) * 32) + (0x09 * 4)) = (uint32_t)DISABLE;
}

...
#line 76 "..\\..\\Drivers\\STM32F2xx_HAL_Driver\\Src\\stm32f2xx_ll_fsmc.c"
...
{ 
  ...
  tmpr = (uint32_t)(Init->DataAddressMux       |                    Init->MemoryType           |                    Init->MemoryDataWidth      |                    Init->BurstAccessMode      |                    Init->WaitSignalPolarity   |                    Init->WrapMode             |                    Init->WaitSignalActive     |                    Init->WriteOperation       |                    Init->WaitSignal           |                    Init->ExtendedMode         |                    Init->AsynchronousWait     |                    Init->WriteBurst
#line 179 "..\\..\\Drivers\\STM32F2xx_HAL_Driver\\Src\\stm32f2xx_ll_fsmc.c"
                    );
...
#line 256 "..\\..\\Drivers\\STM32F2xx_HAL_Driver\\Src\\stm32f2xx_ll_fsmc.c"
                    );
...
HAL_StatusTypeDef  FSMC_NORSRAM_Extended_Timing_Init(FSMC_Bank1E_TypeDef *Device, FSMC_NORSRAM_TimingTypeDef *Timing, uint32_t Bank, uint32_t ExtendedMode)
{
  ...
  if(ExtendedMode == ((uint32_t)0x00004000))
  {
    ...
    Device->BWTR[Bank] = (uint32_t)(Timing->AddressSetupTime                 |                                   ((Timing->AddressHoldTime) << 4)          |                                   ((Timing->DataSetupTime) << 8)            |                                   ((Timing->BusTurnAroundDuration) << 16)   |                                   (((Timing->CLKDivision)-1) << 20)         |                                   (((Timing->DataLatency)-2) << 24)         |                                   (Timing->AccessMode));
#line 292 "..\\..\\Drivers\\STM32F2xx_HAL_Driver\\Src\\stm32f2xx_ll_fsmc.c"
  }
  else                                        
  {
...
HAL_StatusTypeDef FSMC_NAND_Init(FSMC_Bank2_3_TypeDef *Device, FSMC_NAND_InitTypeDef *Init)
{
  ...
  tmppcr = (uint32_t)(Init->Waitfeature                |                      ((uint32_t)0x00000008)         |                      Init->MemoryDataWidth            |                      Init->EccComputation             |                      Init->ECCPageSize                |                      ((Init->TCLRSetupTime) << 9)     |                      ((Init->TARSetupTime) << 13)
#line 428 "..\\..\\Drivers\\STM32F2xx_HAL_Driver\\Src\\stm32f2xx_ll_fsmc.c"
                      );   
  
  if(Init->NandBank == ((uint32_t)0x00000010))
  {
...
HAL_StatusTypeDef FSMC_NAND_CommonSpace_Timing_Init(FSMC_Bank2_3_TypeDef *Device, FSMC_NAND_PCC_TimingTypeDef *Timing, uint32_t Bank)
{
  ...
  tmppmem = (uint32_t)(Timing->SetupTime                  |                       ((Timing->WaitSetupTime) << 8)     |                       ((Timing->HoldSetupTime) << 16)    |                       ((Timing->HiZSetupTime) << 24)



                       );
                            
  if(Bank == ((uint32_t)0x00000010))
  {
...
HAL_StatusTypeDef FSMC_NAND_AttributeSpace_Timing_Init(FSMC_Bank2_3_TypeDef *Device, FSMC_NAND_PCC_TimingTypeDef *Timing, uint32_t Bank)
{
  ...
  tmppatt = (uint32_t)(Timing->SetupTime                  |                       ((Timing->WaitSetupTime) << 8)     |                       ((Timing->HoldSetupTime) << 16)    |                       ((Timing->HiZSetupTime) << 24)
...
HAL_StatusTypeDef FSMC_NAND_DeInit(FSMC_Bank2_3_TypeDef *Device, uint32_t Bank)
{
  ...
  (((Bank) == ((uint32_t)0x00000010))? ((Device)->PCR2 &= ~((uint32_t)0x00000004)): ((Device)->PCR3 &= ~((uint32_t)0x00000004)));
...
HAL_StatusTypeDef  FSMC_NAND_ECC_Enable(FSMC_Bank2_3_TypeDef *Device, uint32_t Bank)
{
  ...
  if(Bank == ((uint32_t)0x00000010))
  {
    Device->PCR2 |= ((uint32_t)0x00000040);
  }
  else
  {
    Device->PCR3 |= ((uint32_t)0x00000040);
  } 
...
HAL_StatusTypeDef FSMC_NAND_GetECC(FSMC_Bank2_3_TypeDef *Device, uint32_t *ECCval, uint32_t Bank, uint32_t Timeout)
{
  ...
  while((((Bank) == ((uint32_t)0x00000010))? (((Device)->SR2 &(((uint32_t)0x00000040))) == (((uint32_t)0x00000040))): (((Device)->SR3 &(((uint32_t)0x00000040))) == (((uint32_t)0x00000040)))))
  {
...
HAL_StatusTypeDef FSMC_PCCARD_Init(FSMC_Bank4_TypeDef *Device, FSMC_PCCARD_InitTypeDef *Init)
{
  ...
  Device->PCR4 = (uint32_t)(Init->Waitfeature               |                            ((uint32_t)0x00000010)   |                            (Init->TCLRSetupTime << 9)      |                            (Init->TARSetupTime << 13));
...
HAL_StatusTypeDef FSMC_PCCARD_CommonSpace_Timing_Init(FSMC_Bank4_TypeDef *Device, FSMC_NAND_PCC_TimingTypeDef *Timing)
{
  ...
  Device->PMEM4 = (uint32_t)((Timing->SetupTime                 |                             ((Timing->WaitSetupTime) << 8)     |                              (Timing->HoldSetupTime) << 16)    |                              ((Timing->HiZSetupTime) << 24)
...
HAL_StatusTypeDef FSMC_PCCARD_AttributeSpace_Timing_Init(FSMC_Bank4_TypeDef *Device, FSMC_NAND_PCC_TimingTypeDef *Timing)
{
  ...
  Device->PATT4 = (uint32_t)((Timing->SetupTime                 |                             ((Timing->WaitSetupTime) << 8)     |                              (Timing->HoldSetupTime) << 16)    |                              ((Timing->HiZSetupTime) << 24)
...
HAL_StatusTypeDef FSMC_PCCARD_IOSpace_Timing_Init(FSMC_Bank4_TypeDef *Device, FSMC_NAND_PCC_TimingTypeDef *Timing)
{
  ...
  Device->PIO4 = (uint32_t)((Timing->SetupTime                  |                             ((Timing->WaitSetupTime) << 8)     |                              (Timing->HoldSetupTime) << 16)    |                              ((Timing->HiZSetupTime) << 24)
...
HAL_StatusTypeDef FSMC_PCCARD_DeInit(FSMC_Bank4_TypeDef *Device)
{
  ...
  ((Device)->PCR4 &= ~((uint32_t)0x00000004));

...
#line 104 "..\\..\\Drivers\\STM32F2xx_HAL_Driver\\Src\\stm32f2xx_hal_can.c"
...
HAL_StatusTypeDef HAL_CAN_Init(CAN_HandleTypeDef* hcan)
{
  ...
  hcan->Instance->MCR &= (~(uint32_t)((uint32_t)0x00000002));

   
  hcan->Instance->MCR |= ((uint32_t)0x00000001) ;
  
   
  timeout = HAL_GetTick() + 10;   
  
   
  while((hcan->Instance->MSR & ((uint32_t)0x00000001)) != ((uint32_t)0x00000001))
  {
    if(HAL_GetTick() >= timeout)
    {
      hcan->State= HAL_CAN_STATE_TIMEOUT;
       
      do{ (hcan)->Lock = HAL_UNLOCKED; }while (0);
      return HAL_TIMEOUT;
    }
  }

   
  if ((hcan->Instance->MSR & ((uint32_t)0x00000001)) != ((uint32_t)0x00000001))
  {
  ...
  else 
  {
    ...
    {
      hcan->Instance->MCR |= ((uint32_t)0x00000080);
    }
    else
    {
      hcan->Instance->MCR &= ~(uint32_t)((uint32_t)0x00000080);
    }

     
    if (hcan->Init.ABOM == ENABLE)
    {
      hcan->Instance->MCR |= ((uint32_t)0x00000040);
    }
    else
    {
      hcan->Instance->MCR &= ~(uint32_t)((uint32_t)0x00000040);
    }

     
    if (hcan->Init.AWUM == ENABLE)
    {
      hcan->Instance->MCR |= ((uint32_t)0x00000020);
    }
    else
    {
      hcan->Instance->MCR &= ~(uint32_t)((uint32_t)0x00000020);
    }

     
    if (hcan->Init.NART == ENABLE)
    {
      hcan->Instance->MCR |= ((uint32_t)0x00000010);
    }
    else
    {
      hcan->Instance->MCR &= ~(uint32_t)((uint32_t)0x00000010);
    }

     
    if (hcan->Init.RFLM == ENABLE)
    {
      hcan->Instance->MCR |= ((uint32_t)0x00000008);
    }
    else
    {
      hcan->Instance->MCR &= ~(uint32_t)((uint32_t)0x00000008);
    }

     
    if (hcan->Init.TXFP == ENABLE)
    {
      hcan->Instance->MCR |= ((uint32_t)0x00000004);
    }
    else
    {
      hcan->Instance->MCR &= ~(uint32_t)((uint32_t)0x00000004);
    }

     
    hcan->Instance->BTR = (uint32_t)((uint32_t)hcan->Init.Mode) |                 ((uint32_t)hcan->Init.SJW) |                 ((uint32_t)hcan->Init.BS1) |                 ((uint32_t)hcan->Init.BS2) |                ((uint32_t)hcan->Init.Prescaler - 1);
    ...
    hcan->Instance->MCR &= ~(uint32_t)((uint32_t)0x00000001);
...
HAL_StatusTypeDef HAL_CAN_ConfigFilter(CAN_HandleTypeDef* hcan, CAN_FilterConfTypeDef* sFilterConfig)
{
  ...
  ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FMR |= (uint32_t)((uint32_t)0x00000001);
  
   
  ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FMR &= ~((uint32_t)((uint32_t)0x00003F00));
  ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FMR |= (uint32_t)(sFilterConfig->BankNumber << 8);
     
   
  ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FA1R &= ~(uint32_t)filternbrbitpos;

   
  if (sFilterConfig->FilterScale == ((uint8_t)0x00))
  {
     
    ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FS1R &= ~(uint32_t)filternbrbitpos;

     
     
    ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->sFilterRegister[sFilterConfig->FilterNumber].FR1 = 
       ((0x0000FFFF & (uint32_t)sFilterConfig->FilterMaskIdLow) << 16) |
        (0x0000FFFF & (uint32_t)sFilterConfig->FilterIdLow);

     
     
    ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->sFilterRegister[sFilterConfig->FilterNumber].FR2 = 
       ((0x0000FFFF & (uint32_t)sFilterConfig->FilterMaskIdHigh) << 16) |
        (0x0000FFFF & (uint32_t)sFilterConfig->FilterIdHigh);
  }

  if (sFilterConfig->FilterScale == ((uint8_t)0x01))
  {
     
    ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FS1R |= filternbrbitpos;
  ...
  if (sFilterConfig->FilterMode == ((uint8_t)0x00))
  {
     
    ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FM1R &= ~(uint32_t)filternbrbitpos;
  }
  else  
  {
  ...
  if (sFilterConfig->FilterFIFOAssignment == ((uint8_t)0x00))
  {
     
    ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FFA1R &= ~(uint32_t)filternbrbitpos;
  }

  if (sFilterConfig->FilterFIFOAssignment == ((uint8_t)0x01))
  {
  ...
  {
    ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400))->FA1R |= filternbrbitpos;
  }
...
HAL_StatusTypeDef HAL_CAN_Transmit(CAN_HandleTypeDef* hcan, uint32_t Timeout)
{
  ...
  do{ if((hcan)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hcan)->Lock = HAL_LOCKED; } }while (0);
  ...
  if ((hcan->Instance->TSR&((uint32_t)0x04000000)) == ((uint32_t)0x04000000))
  {
    transmitmailbox = 0;
  }
  else if ((hcan->Instance->TSR&((uint32_t)0x08000000)) == ((uint32_t)0x08000000))
  {
    transmitmailbox = 1;
  }
  else if ((hcan->Instance->TSR&((uint32_t)0x10000000)) == ((uint32_t)0x10000000))
  {
    transmitmailbox = 2;
  }
  else
  {
    transmitmailbox = ((uint8_t)0x04);
  }

  if (transmitmailbox != ((uint8_t)0x04))
  {
     
    hcan->Instance->sTxMailBox[transmitmailbox].TIR &= ((uint32_t)0x00000001);
    if (hcan->pTxMsg->IDE == ((uint32_t)0x00000000))
    {
      ((void)0);  
    ...
    while(!((((transmitmailbox) == ((uint8_t)0x00))? ((((hcan)->Instance ->TSR) & (((uint32_t)0x00000001) | ((uint32_t)0x00000002) | ((uint32_t)0x04000000))) == (((uint32_t)0x00000001) | ((uint32_t)0x00000002) | ((uint32_t)0x04000000))) : ((transmitmailbox) == ((uint8_t)0x01))? ((((hcan)->Instance ->TSR) & (((uint32_t)0x00000100) | ((uint32_t)0x00000200) | ((uint32_t)0x08000000))) == (((uint32_t)0x00000100) | ((uint32_t)0x00000200) | ((uint32_t)0x08000000))) : ((((hcan)->Instance ->TSR) & (((uint32_t)0x00010000) | ((uint32_t)0x00020000) | ((uint32_t)0x10000000))) == (((uint32_t)0x00010000) | ((uint32_t)0x00020000) | ((uint32_t)0x10000000))))))
    {
...
HAL_StatusTypeDef HAL_CAN_Transmit_IT(CAN_HandleTypeDef* hcan)
{
  ...
  if((tmp == HAL_CAN_STATE_READY) || (tmp == HAL_CAN_STATE_BUSY_RX))
  {
    ...
    if(transmitmailbox != ((uint8_t)0x04))
    {
      ...
      (((hcan)->Instance ->IER) |= (((uint32_t)((uint32_t)0x00000100))));
      
       
      (((hcan)->Instance ->IER) |= (((uint32_t)((uint32_t)0x00000200))));
      
       
      (((hcan)->Instance ->IER) |= (((uint32_t)((uint32_t)0x00000400))));
      
       
      (((hcan)->Instance ->IER) |= (((uint32_t)((uint32_t)0x00000800))));
      
       
      (((hcan)->Instance ->IER) |= (((uint32_t)((uint32_t)0x00008000))));
      
       
      (((hcan)->Instance ->IER) |= (((uint32_t)((uint32_t)0x00000001))));
...
HAL_StatusTypeDef HAL_CAN_Receive(CAN_HandleTypeDef* hcan, uint8_t FIFONumber, uint32_t Timeout)
{
  ...
  while((((FIFONumber) == ((uint8_t)0x00))? ((uint8_t)((hcan)->Instance ->RF0R&(uint32_t)0x03)) : ((uint8_t)((hcan)->Instance ->RF1R&(uint32_t)0x03))) == 0)
  {
  ...
  if (hcan->pRxMsg->IDE == ((uint32_t)0x00000000))
  {
  ...
  if(FIFONumber == ((uint8_t)0x00))
  {
    ...
    (((((uint8_t)0x00)) == ((uint8_t)0x00))? ((hcan)->Instance ->RF0R |= ((uint32_t)0x00000020)) : ((hcan)->Instance ->RF1R |= ((uint32_t)0x00000020)));
  }
  else  
  {
     
    (((((uint8_t)0x01)) == ((uint8_t)0x00))? ((hcan)->Instance ->RF0R |= ((uint32_t)0x00000020)) : ((hcan)->Instance ->RF1R |= ((uint32_t)0x00000020)));
  }
...
HAL_StatusTypeDef HAL_CAN_Receive_IT(CAN_HandleTypeDef* hcan, uint8_t FIFONumber)
{
  ...
  if((tmp == HAL_CAN_STATE_READY) || (tmp == HAL_CAN_STATE_BUSY_TX))
  {
    ...
    if(FIFONumber == ((uint8_t)0x00))
    {
      ...
      (((hcan)->Instance ->IER) |= (((uint32_t)((uint32_t)0x00000002))));
    }
    else
    {
       
      (((hcan)->Instance ->IER) |= (((uint32_t)((uint32_t)0x00000010))));
    }
...
HAL_StatusTypeDef HAL_CAN_Sleep(CAN_HandleTypeDef* hcan)
{
  ...
  hcan->State = HAL_CAN_STATE_BUSY; 
   ...
   hcan->Instance->MCR = (((hcan->Instance->MCR) & (uint32_t)(~(uint32_t)((uint32_t)0x00000001))) | ((uint32_t)0x00000002));
   
   
  if ((hcan->Instance->MSR & (((uint32_t)0x00000002)|((uint32_t)0x00000001))) != ((uint32_t)0x00000002))
  {
  ...
  while((hcan->Instance->MSR & (((uint32_t)0x00000002)|((uint32_t)0x00000001))) != ((uint32_t)0x00000002))
  {
    if(HAL_GetTick() >= timeout)
    {
      hcan->State = HAL_CAN_STATE_TIMEOUT;
...
HAL_StatusTypeDef HAL_CAN_WakeUp(CAN_HandleTypeDef* hcan)
{
  ...
  while((hcan->Instance->MSR & ((uint32_t)0x00000002)) == ((uint32_t)0x00000002))
  {
    if(HAL_GetTick() >= timeout)
    {
      hcan->State= HAL_CAN_STATE_TIMEOUT;
  ...
  if((hcan->Instance->MSR & ((uint32_t)0x00000002)) == ((uint32_t)0x00000002))
  {
...
void HAL_CAN_IRQHandler(CAN_HandleTypeDef* hcan)
{
  ...
  if(((((hcan)->Instance ->IER & (((uint32_t)((uint32_t)0x00000001)))) == (((uint32_t)((uint32_t)0x00000001)))) ? SET : RESET))
  {
    tmp1 = (((((uint8_t)0x00)) == ((uint8_t)0x00))? ((((hcan)->Instance ->TSR) & (((uint32_t)0x00000001) | ((uint32_t)0x00000002) | ((uint32_t)0x04000000))) == (((uint32_t)0x00000001) | ((uint32_t)0x00000002) | ((uint32_t)0x04000000))) : ((((uint8_t)0x00)) == ((uint8_t)0x01))? ((((hcan)->Instance ->TSR) & (((uint32_t)0x00000100) | ((uint32_t)0x00000200) | ((uint32_t)0x08000000))) == (((uint32_t)0x00000100) | ((uint32_t)0x00000200) | ((uint32_t)0x08000000))) : ((((hcan)->Instance ->TSR) & (((uint32_t)0x00010000) | ((uint32_t)0x00020000) | ((uint32_t)0x10000000))) == (((uint32_t)0x00010000) | ((uint32_t)0x00020000) | ((uint32_t)0x10000000))));
    tmp2 = (((((uint8_t)0x01)) == ((uint8_t)0x00))? ((((hcan)->Instance ->TSR) & (((uint32_t)0x00000001) | ((uint32_t)0x00000002) | ((uint32_t)0x04000000))) == (((uint32_t)0x00000001) | ((uint32_t)0x00000002) | ((uint32_t)0x04000000))) : ((((uint8_t)0x01)) == ((uint8_t)0x01))? ((((hcan)->Instance ->TSR) & (((uint32_t)0x00000100) | ((uint32_t)0x00000200) | ((uint32_t)0x08000000))) == (((uint32_t)0x00000100) | ((uint32_t)0x00000200) | ((uint32_t)0x08000000))) : ((((hcan)->Instance ->TSR) & (((uint32_t)0x00010000) | ((uint32_t)0x00020000) | ((uint32_t)0x10000000))) == (((uint32_t)0x00010000) | ((uint32_t)0x00020000) | ((uint32_t)0x10000000))));
    tmp3 = (((((uint8_t)0x02)) == ((uint8_t)0x00))? ((((hcan)->Instance ->TSR) & (((uint32_t)0x00000001) | ((uint32_t)0x00000002) | ((uint32_t)0x04000000))) == (((uint32_t)0x00000001) | ((uint32_t)0x00000002) | ((uint32_t)0x04000000))) : ((((uint8_t)0x02)) == ((uint8_t)0x01))? ((((hcan)->Instance ->TSR) & (((uint32_t)0x00000100) | ((uint32_t)0x00000200) | ((uint32_t)0x08000000))) == (((uint32_t)0x00000100) | ((uint32_t)0x00000200) | ((uint32_t)0x08000000))) : ((((hcan)->Instance ->TSR) & (((uint32_t)0x00010000) | ((uint32_t)0x00020000) | ((uint32_t)0x10000000))) == (((uint32_t)0x00010000) | ((uint32_t)0x00020000) | ((uint32_t)0x10000000))));
    if(tmp1 || tmp2 || tmp3)  
    {
  ...
  tmp1 = (((((uint8_t)0x00)) == ((uint8_t)0x00))? ((uint8_t)((hcan)->Instance ->RF0R&(uint32_t)0x03)) : ((uint8_t)((hcan)->Instance ->RF1R&(uint32_t)0x03)));
  tmp2 = ((((hcan)->Instance ->IER & (((uint32_t)((uint32_t)0x00000002)))) == (((uint32_t)((uint32_t)0x00000002)))) ? SET : RESET);
   
  if((tmp1 != 0) && tmp2)
  {
     
    CAN_Receive_IT(hcan, ((uint8_t)0x00));
  }
  
  tmp1 = (((((uint8_t)0x01)) == ((uint8_t)0x00))? ((uint8_t)((hcan)->Instance ->RF0R&(uint32_t)0x03)) : ((uint8_t)((hcan)->Instance ->RF1R&(uint32_t)0x03)));
  tmp2 = ((((hcan)->Instance ->IER & (((uint32_t)((uint32_t)0x00000010)))) == (((uint32_t)((uint32_t)0x00000010)))) ? SET : RESET);
   
  if((tmp1 != 0) && tmp2)
  {
     
    CAN_Receive_IT(hcan, ((uint8_t)0x01));
  }
  
  tmp1 = ((((((uint32_t)0x00000300)) >> 8) == 5)? ((((hcan)->Instance ->TSR) & (1 << ((((uint32_t)0x00000300)) & ((uint32_t)0x000000FF)))) == (1 << ((((uint32_t)0x00000300)) & ((uint32_t)0x000000FF)))): (((((uint32_t)0x00000300)) >> 8) == 2)? ((((hcan)->Instance ->RF0R) & (1 << ((((uint32_t)0x00000300)) & ((uint32_t)0x000000FF)))) == (1 << ((((uint32_t)0x00000300)) & ((uint32_t)0x000000FF)))): (((((uint32_t)0x00000300)) >> 8) == 4)? ((((hcan)->Instance ->RF1R) & (1 << ((((uint32_t)0x00000300)) & ((uint32_t)0x000000FF)))) == (1 << ((((uint32_t)0x00000300)) & ((uint32_t)0x000000FF)))): (((((uint32_t)0x00000300)) >> 8) == 1)? ((((hcan)->Instance ->MSR) & (1 << ((((uint32_t)0x00000300)) & ((uint32_t)0x000000FF)))) == (1 << ((((uint32_t)0x00000300)) & ((uint32_t)0x000000FF)))): ((((hcan)->Instance ->ESR) & (1 << ((((uint32_t)0x00000300)) & ((uint32_t)0x000000FF)))) == (1 << ((((uint32_t)0x00000300)) & ((uint32_t)0x000000FF)))));
  tmp2 = ((((hcan)->Instance ->IER & (((uint32_t)((uint32_t)0x00000100)))) == (((uint32_t)((uint32_t)0x00000100)))) ? SET : RESET);
  tmp3 = ((((hcan)->Instance ->IER & (((uint32_t)((uint32_t)0x00008000)))) == (((uint32_t)((uint32_t)0x00008000)))) ? SET : RESET);
  ...
  if(tmp1 && tmp2 && tmp3)
  {
    ...
    ((((((uint32_t)0x00000300)) >> 8) == 5)? (((hcan)->Instance ->TSR) &= ~((uint32_t)1 << ((((uint32_t)0x00000300)) & ((uint32_t)0x000000FF)))): (((((uint32_t)0x00000300)) >> 8) == 2)? (((hcan)->Instance ->RF0R) &= ~((uint32_t)1 << ((((uint32_t)0x00000300)) & ((uint32_t)0x000000FF)))): (((((uint32_t)0x00000300)) >> 8) == 4)? (((hcan)->Instance ->RF1R) &= ~((uint32_t)1 << ((((uint32_t)0x00000300)) & ((uint32_t)0x000000FF)))): (((((uint32_t)0x00000300)) >> 8) == 1)? (((hcan)->Instance ->MSR) &= ~((uint32_t)1 << ((((uint32_t)0x00000300)) & ((uint32_t)0x000000FF)))): (((hcan)->Instance ->ESR) &= ~((uint32_t)1 << ((((uint32_t)0x00000300)) & ((uint32_t)0x000000FF)))));
  }
  
  tmp1 = ((((((uint32_t)0x00000301)) >> 8) == 5)? ((((hcan)->Instance ->TSR) & (1 << ((((uint32_t)0x00000301)) & ((uint32_t)0x000000FF)))) == (1 << ((((uint32_t)0x00000301)) & ((uint32_t)0x000000FF)))): (((((uint32_t)0x00000301)) >> 8) == 2)? ((((hcan)->Instance ->RF0R) & (1 << ((((uint32_t)0x00000301)) & ((uint32_t)0x000000FF)))) == (1 << ((((uint32_t)0x00000301)) & ((uint32_t)0x000000FF)))): (((((uint32_t)0x00000301)) >> 8) == 4)? ((((hcan)->Instance ->RF1R) & (1 << ((((uint32_t)0x00000301)) & ((uint32_t)0x000000FF)))) == (1 << ((((uint32_t)0x00000301)) & ((uint32_t)0x000000FF)))): (((((uint32_t)0x00000301)) >> 8) == 1)? ((((hcan)->Instance ->MSR) & (1 << ((((uint32_t)0x00000301)) & ((uint32_t)0x000000FF)))) == (1 << ((((uint32_t)0x00000301)) & ((uint32_t)0x000000FF)))): ((((hcan)->Instance ->ESR) & (1 << ((((uint32_t)0x00000301)) & ((uint32_t)0x000000FF)))) == (1 << ((((uint32_t)0x00000301)) & ((uint32_t)0x000000FF)))));
  tmp2 = ((((hcan)->Instance ->IER & (((uint32_t)((uint32_t)0x00000200)))) == (((uint32_t)((uint32_t)0x00000200)))) ? SET : RESET);
  tmp3 = ((((hcan)->Instance ->IER & (((uint32_t)((uint32_t)0x00008000)))) == (((uint32_t)((uint32_t)0x00008000)))) ? SET : RESET); 
  ...
  if(tmp1 && tmp2 && tmp3)
  {
    ...
    ((((((uint32_t)0x00000301)) >> 8) == 5)? (((hcan)->Instance ->TSR) &= ~((uint32_t)1 << ((((uint32_t)0x00000301)) & ((uint32_t)0x000000FF)))): (((((uint32_t)0x00000301)) >> 8) == 2)? (((hcan)->Instance ->RF0R) &= ~((uint32_t)1 << ((((uint32_t)0x00000301)) & ((uint32_t)0x000000FF)))): (((((uint32_t)0x00000301)) >> 8) == 4)? (((hcan)->Instance ->RF1R) &= ~((uint32_t)1 << ((((uint32_t)0x00000301)) & ((uint32_t)0x000000FF)))): (((((uint32_t)0x00000301)) >> 8) == 1)? (((hcan)->Instance ->MSR) &= ~((uint32_t)1 << ((((uint32_t)0x00000301)) & ((uint32_t)0x000000FF)))): (((hcan)->Instance ->ESR) &= ~((uint32_t)1 << ((((uint32_t)0x00000301)) & ((uint32_t)0x000000FF)))));
  }
  
  tmp1 = ((((((uint32_t)0x00000302)) >> 8) == 5)? ((((hcan)->Instance ->TSR) & (1 << ((((uint32_t)0x00000302)) & ((uint32_t)0x000000FF)))) == (1 << ((((uint32_t)0x00000302)) & ((uint32_t)0x000000FF)))): (((((uint32_t)0x00000302)) >> 8) == 2)? ((((hcan)->Instance ->RF0R) & (1 << ((((uint32_t)0x00000302)) & ((uint32_t)0x000000FF)))) == (1 << ((((uint32_t)0x00000302)) & ((uint32_t)0x000000FF)))): (((((uint32_t)0x00000302)) >> 8) == 4)? ((((hcan)->Instance ->RF1R) & (1 << ((((uint32_t)0x00000302)) & ((uint32_t)0x000000FF)))) == (1 << ((((uint32_t)0x00000302)) & ((uint32_t)0x000000FF)))): (((((uint32_t)0x00000302)) >> 8) == 1)? ((((hcan)->Instance ->MSR) & (1 << ((((uint32_t)0x00000302)) & ((uint32_t)0x000000FF)))) == (1 << ((((uint32_t)0x00000302)) & ((uint32_t)0x000000FF)))): ((((hcan)->Instance ->ESR) & (1 << ((((uint32_t)0x00000302)) & ((uint32_t)0x000000FF)))) == (1 << ((((uint32_t)0x00000302)) & ((uint32_t)0x000000FF)))));
  tmp2 = ((((hcan)->Instance ->IER & (((uint32_t)((uint32_t)0x00000400)))) == (((uint32_t)((uint32_t)0x00000400)))) ? SET : RESET);
  tmp3 = ((((hcan)->Instance ->IER & (((uint32_t)((uint32_t)0x00008000)))) == (((uint32_t)((uint32_t)0x00008000)))) ? SET : RESET);  
  ...
  if(tmp1 && tmp2 && tmp3)
  {
    ...
    ((((((uint32_t)0x00000302)) >> 8) == 5)? (((hcan)->Instance ->TSR) &= ~((uint32_t)1 << ((((uint32_t)0x00000302)) & ((uint32_t)0x000000FF)))): (((((uint32_t)0x00000302)) >> 8) == 2)? (((hcan)->Instance ->RF0R) &= ~((uint32_t)1 << ((((uint32_t)0x00000302)) & ((uint32_t)0x000000FF)))): (((((uint32_t)0x00000302)) >> 8) == 4)? (((hcan)->Instance ->RF1R) &= ~((uint32_t)1 << ((((uint32_t)0x00000302)) & ((uint32_t)0x000000FF)))): (((((uint32_t)0x00000302)) >> 8) == 1)? (((hcan)->Instance ->MSR) &= ~((uint32_t)1 << ((((uint32_t)0x00000302)) & ((uint32_t)0x000000FF)))): (((hcan)->Instance ->ESR) &= ~((uint32_t)1 << ((((uint32_t)0x00000302)) & ((uint32_t)0x000000FF)))));
  }
  
  tmp1 = (((hcan->Instance ->ESR) & (((uint32_t)0x00000070))) == RESET);
  tmp2 = ((((hcan)->Instance ->IER & (((uint32_t)((uint32_t)0x00000800)))) == (((uint32_t)((uint32_t)0x00000800)))) ? SET : RESET);
  tmp3 = ((((hcan)->Instance ->IER & (((uint32_t)((uint32_t)0x00008000)))) == (((uint32_t)((uint32_t)0x00008000)))) ? SET : RESET);
   
  if((!tmp1) && tmp2 && tmp3)
  {
    tmp1 = (hcan->Instance->ESR) & ((uint32_t)0x00000070);
    switch(tmp1)
    {
      ...
      case(((uint32_t)0x00000020)):
          ...
          hcan->ErrorCode |= 0x10;
          break;
      case(((uint32_t)0x00000020) | ((uint32_t)0x00000010)):
      ...
      case(((uint32_t)0x00000040)):
          ...
          hcan->ErrorCode |= 0x40;
          break;
      case(((uint32_t)0x00000040) | ((uint32_t)0x00000010)):
           
          hcan->ErrorCode |= 0x80;
          break;
      case(((uint32_t)0x00000040) | ((uint32_t)0x00000020)):
           
          hcan->ErrorCode |= 0x100;
          break;
      default:
          break;
    }
    ...
    hcan->Instance->ESR &= ~(((uint32_t)0x00000070));
  }
  
   
  if(hcan->ErrorCode != 0x00)
  {

...
void MX_RNG_Init(void)
{
  ...
  hrng.Instance = ((RNG_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x60800));
  HAL_RNG_Init(&hrng);
...
void HAL_RNG_MspInit(RNG_HandleTypeDef* hrng)
{
  ...
  if(hrng->Instance==((RNG_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x60800)))
  {
     
    (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB2ENR |= (((uint32_t)0x00000040)));
  }
}

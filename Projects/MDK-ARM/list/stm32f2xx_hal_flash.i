...
#line 97 "..\\..\\Drivers\\STM32F2xx_HAL_Driver\\Src\\stm32f2xx_hal_flash.c"
...
HAL_StatusTypeDef HAL_FLASH_Program(uint32_t TypeProgram, uint32_t Address, uint64_t Data)
{
  ...
  if(status == HAL_OK)
  {
    ...
    else if(TypeProgram == ((uint32_t)0x01))
    {
...
void HAL_FLASH_IRQHandler(void)
{
  ...
  if(((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3C00))->SR & ((((uint32_t)0x00000002) | ((uint32_t)0x00000010) | ((uint32_t)0x00000020) | ((uint32_t)0x00000040) | ((uint32_t)0x00000080) | ((uint32_t)0x00000100))))) != RESET)

  {
    ...
    (((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3C00))->SR = (((uint32_t)0x00000002) | ((uint32_t)0x00000010) | ((uint32_t)0x00000020) | ((uint32_t)0x00000040) | ((uint32_t)0x00000080) | ((uint32_t)0x00000100)));
...
{ 
  ...
  if(((((FLASH_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3C00))->SR & (((uint32_t)0x00000100)))) != RESET)
  {

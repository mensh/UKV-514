...
MT_uint8 __wait_for_ready(void);
...
void PLATFORM_Init(void)
{
  ...
  (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1ENR |= (((uint32_t)0x00000080)));
  (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1ENR |= (((uint32_t)0x00000010)));
  (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1ENR |= (((uint32_t)0x00000008)));
  (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1ENR |= (((uint32_t)0x00000001)));
  (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1ENR |= (((uint32_t)0x00000040)));
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x0080)|((uint16_t)0x0100)|((uint16_t)0x0200)|((uint16_t)0x0400);
  ...
  GPIO_InitStruct.Alternate = ((uint8_t)0xC);
  HAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000)), &GPIO_InitStruct);

  GPIO_InitStruct.Pin = ((uint16_t)0x4000)|((uint16_t)0x8000)|((uint16_t)0x0001)|((uint16_t)0x0002);
  GPIO_InitStruct.Mode = ((uint32_t)0x00000002);
  GPIO_InitStruct.Pull = ((uint32_t)0x00000000);
  GPIO_InitStruct.Speed = ((uint32_t)0x00000003);
  GPIO_InitStruct.Alternate = ((uint8_t)0xC);
  ...
  GPIO_InitStruct.Pin = ((uint16_t)0x0800)|((uint16_t)0x1000)|((uint16_t)0x0010)|((uint16_t)0x0020);
  GPIO_InitStruct.Mode = ((uint32_t)0x00000002);
  GPIO_InitStruct.Pull = ((uint32_t)0x00000000);
  GPIO_InitStruct.Speed = ((uint32_t)0x00000003);
  GPIO_InitStruct.Alternate = ((uint8_t)0xC);
  ...
  GPIO_InitStruct.Speed = ((uint32_t)0x00000003);
	GPIO_InitStruct.Alternate = ((uint8_t)0xC);
  HAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1800)), &GPIO_InitStruct);
  ...
  HAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), &GPIO_InitStruct);
	...
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)),((uint16_t)0x0008),GPIO_PIN_SET);

	(((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB3ENR |= (((uint32_t)0x00000001)));

	nandHandle.Instance  = ((FSMC_Bank2_3_TypeDef *) (((uint32_t)0xA0000000) + 0x0060));
   
  NAND_Timing.SetupTime     = 0x01;
  NAND_Timing.WaitSetupTime = 0x03;
  NAND_Timing.HoldSetupTime = 0x02;
  NAND_Timing.HiZSetupTime  = 0x01;

  nandHandle.Init.NandBank        = ((uint32_t)0x00000010);
  nandHandle.Init.Waitfeature     = ((uint32_t)0x00000002);
  nandHandle.Init.MemoryDataWidth = ((uint32_t)0x00000000);
  nandHandle.Init.EccComputation  = ((uint32_t)0x00000040);
  nandHandle.Init.ECCPageSize     = ((uint32_t)0x00080000);
  nandHandle.Init.TCLRSetupTime   = 0;
  nandHandle.Init.TARSetupTime    = 0;

  nandHandle.Info.PageSize=4096;        
  nandHandle.Info.SpareAreaSize=224;   
  nandHandle.Info.BlockSize=128;       
  nandHandle.Info.BlockNbr=2048;        
  nandHandle.Info.ZoneSize=4096;        

	HAL_NAND_Init(&nandHandle, &NAND_Timing, &NAND_Timing);
}
...
void PLATFORM_SendCmd(bus_t ubCommand)
	{
	*(volatile uint8_t *)(((uint32_t)0x70000000) | ((uint32_t)(1<<16))) = ubCommand;
	}
...
void PLATFORM_SendAddr(bus_t ubAddress)
	{
	*(volatile uint8_t *)(((uint32_t)0x70000000) | ((uint32_t)(1<<17))) = ubAddress;
	}
...
void PLATFORM_SendData(bus_t data)
	{
	*(volatile uint8_t *)(((uint32_t)0x70000000) | ((uint32_t)0x00000000)) = data;
	}
...
bus_t PLATFORM_ReadData(void)
	...
	Data = *(volatile uint8_t *)(((uint32_t)0x70000000) | ((uint32_t)0x00000000));
	return Data;
	}
...
void PLATFORM_Wait(int microseconds)
	...
	while( HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1800)), ((uint16_t)0x0040)) == GPIO_PIN_RESET ){}
...
MT_uint8 Init_Driver(void)
	...
	if( strcmp((const char *)onfi_signature, "ONFI") && ( 0x20 != NAND_Read_Param_Page(&device_info)) )
		driver_status = 0;
...
MT_uint8 NAND_Read_ID(flash_width *buffer)
	...
	PLATFORM_SendCmd(0x90);
	PLATFORM_SendAddr(0x00);
...
MT_uint8 NAND_Set_Feature(flash_width feature_address, flash_width subfeature)
	...
	if ((device_info.command & 0x0004) == 0)
		return 0xFD;
...
flash_width NAND_Read_Status(void)
	{
	flash_width ret;
...
flash_width NAND_Read_Status_Enhanced(nand_addr_t addr)
	...
	if(0x00 != __is_valid_addr(addr))
		return 0x30;

	 
	if ((device_info.command & 0x0008) == 0)
		return 0xFD;
...
MT_uint8 NAND_Page_Read(nand_addr_t addr, flash_width *buffer, MT_uint32 lenght)
	...
	if( (device_info.feature & 0x0001) != 0 )
		{
			if( lenght > (device_info.data_bytes_per_page >> 1) )
				return 0x31;
		}
	 
	else if( lenght > device_info.data_bytes_per_page )
		return 0x31;
...
extern void CORE_threadGetData(void);
...
MT_uint8 NAND_Spare_Read(nand_addr_t addr, flash_width *buffer, MT_uint32 lenght) 
	...
	else if(lenght > device_info.spare_bytes_per_page)
		return 0x31;
...
MT_uint8 NAND_Copy_Back(nand_addr_t src_addr, nand_addr_t dest_addr) {
	MT_uint8 src_address_stream[5];
	MT_uint8 dest_address_stream[5];
	MT_uint8 status_reg;
	MT_uint8 ret;
	...
	if ((device_info.command & 0x0010) == 0)
		return 0xFD;

	 
	if((0x00 != __is_valid_addr(src_addr)) || (0x00 != __is_valid_addr(dest_addr)))
		return 0x30;
...
MT_uint8 NAND_Unlock(nand_addr_t start_block, nand_addr_t end_block) {
	MT_uint8 start_address_stream[5];
	MT_uint8 end_address_stream[5];
	...
	if((0x00 != __is_valid_addr(start_block)) || (0x00 != __is_valid_addr(end_block)))
		return 0x30;

	 
	if(2 == __compare_addr(start_block, end_block) )
		return 0x30;
...
MT_uint8 NAND_Read_Lock_Status(nand_addr_t block_addr) {
	...
	if(0x00 != __is_valid_addr(block_addr))
		return 0x30;
...
MT_uint8 NAND_OTP_Mode_Enter(void) {
	...
	ret = NAND_Get_Feature(0x90, &subfeature);

	if((0x00 != subfeature) && (0x03 != subfeature))
		return 0x10;

	 
	ret = NAND_Set_Feature(0x90, 0x01);
...
MT_uint8 NAND_OTP_Mode_Exit(void) {
	...
	if((0x01 != subfeature) && (0x03 != subfeature))
		return 0x10;

	 
	ret = NAND_Set_Feature(0x90, 0x00);
...
MT_uint8 NAND_OTP_Mode_Protect(nand_addr_t addr) {
	MT_uint8 ret;
	flash_width subfeature;
	flash_width write_buf[4096+224];
	...
	ret = NAND_Set_Feature(0x90, 0x03);
...
#line 2332 "..\\..\\Src\\core\\nand_MT29F_lld.c"
	...
	while( (0x40 != (0x40 & PLATFORM_ReadData())) 					&& ((MT_uint32) HAL_GetTick() < (MT_uint32) (clock_start + (2 * 1000))) )

		{    }

	 
	if(HAL_GetTick() >= clock_start + (2 * 1000))
		ret = 0xFE;
	else
		ret = 0x00;
...
MT_uint8 __compare_addr(nand_addr_t first_addr, nand_addr_t second_addr) {
	...
	if((first_addr.lun == second_addr.lun) && 		(first_addr.block == second_addr.block) && 		(first_addr.page == second_addr.page) && 		(first_addr.column == first_addr.column))
...
#line 2456 "..\\..\\Src\\core\\nand_MT29F_lld.c"
	...
	if (64 == device_info.pages_per_block) {
		...
		addr_cycle_stream[0] =
				(MT_uint8) ( ((((addr . column & (1 << 7)) >> 7)) << 7) | ((((addr . column & (1 << 6)) >> 6)) << 6) | ((((addr . column & (1 << 5)) >> 5)) << 5) | ((((addr . column & (1 << 4)) >> 4)) << 4) | ((((addr . column & (1 << 3)) >> 3)) << 3) | ((((addr . column & (1 << 2)) >> 2)) << 2) | ((((addr . column & (1 << 1)) >> 1)) << 1) | ((((addr . column & (1 << 0)) >> 0)) << 0) );;

		 
		addr_cycle_stream[1] =
				(MT_uint8) ( ((0) << 7) | ((0) << 6) | ((((addr . column & (1 << 13)) >> 13)) << 5) | ((((addr . column & (1 << 12)) >> 12)) << 4) | ((((addr . column & (1 << 11)) >> 11)) << 3) | ((((addr . column & (1 << 10)) >> 10)) << 2) | ((((addr . column & (1 << 9)) >> 9)) << 1) | ((((addr . column & (1 << 8)) >> 8)) << 0) );;

		 
		addr_cycle_stream[2] =
				(MT_uint8) ( ((((addr . block & (1 << 1)) >> 1)) << 7) | ((((addr . block & (1 << 0)) >> 0)) << 6) | ((((addr . page & (1 << 5)) >> 5)) << 5) | ((((addr . page & (1 << 4)) >> 4)) << 4) | ((((addr . page & (1 << 3)) >> 3)) << 3) | ((((addr . page & (1 << 2)) >> 2)) << 2) | ((((addr . page & (1 << 1)) >> 1)) << 1) | ((((addr . page & (1 << 0)) >> 0)) << 0) );;

		 
		addr_cycle_stream[3] =
				(MT_uint8) ( ((((addr . block & (1 << 9)) >> 9)) << 7) | ((((addr . block & (1 << 8)) >> 8)) << 6) | ((((addr . block & (1 << 7)) >> 7)) << 5) | ((((addr . block & (1 << 6)) >> 6)) << 4) | ((((addr . block & (1 << 5)) >> 5)) << 3) | ((((addr . block & (1 << 4)) >> 4)) << 2) | ((((addr . block & (1 << 3)) >> 3)) << 1) | ((((addr . block & (1 << 2)) >> 2)) << 0) );;

		 
		addr_cycle_stream[4] =
				(MT_uint8) ( ((0) << 7) | ((0) << 6) | ((0) << 5) | ((0) << 4) | ((((addr . lun & (1 << 0)) >> 0)) << 3) | ((((addr . block & (1 << 12)) >> 12)) << 2) | ((((addr . block & (1 << 11)) >> 11)) << 1) | ((((addr . block & (1 << 10)) >> 10)) << 0) );;
	...
	if (128 == device_info.pages_per_block) {
		...
		addr_cycle_stream[2] =
				(MT_uint8) ( ((((addr . block & (1 << 0)) >> 0)) << 7) | ((((addr . page & (1 << 6)) >> 6)) << 6) | ((((addr . page & (1 << 5)) >> 5)) << 5) | ((((addr . page & (1 << 4)) >> 4)) << 4) | ((((addr . page & (1 << 3)) >> 3)) << 3) | ((((addr . page & (1 << 2)) >> 2)) << 2) | ((((addr . page & (1 << 1)) >> 1)) << 1) | ((((addr . page & (1 << 0)) >> 0)) << 0) );;

		 
		addr_cycle_stream[3] =
				(MT_uint8) ( ((((addr . block & (1 << 8)) >> 8)) << 7) | ((((addr . block & (1 << 7)) >> 7)) << 6) | ((((addr . block & (1 << 6)) >> 6)) << 5) | ((((addr . block & (1 << 5)) >> 5)) << 4) | ((((addr . block & (1 << 4)) >> 4)) << 3) | ((((addr . block & (1 << 3)) >> 3)) << 2) | ((((addr . block & (1 << 2)) >> 2)) << 1) | ((((addr . block & (1 << 1)) >> 1)) << 0) );;

		 
		addr_cycle_stream[4] =
				(MT_uint8) ( ((0) << 7) | ((0) << 6) | ((0) << 5) | ((0) << 4) | ((((addr . lun & (1 << 0)) >> 0)) << 3) | ((((addr . block & (1 << 11)) >> 11)) << 2) | ((((addr . block & (1 << 10)) >> 10)) << 1) | ((((addr . block & (1 << 9)) >> 9)) << 0) );;

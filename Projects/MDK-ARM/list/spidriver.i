...
#line 3 "..\\..\\Src\\core\\spiDriver.c"

static tdSpiDriver spiDriver = { (void *) 0, (void *) 0, (void *) 0 };

uint8_t SPI_DRIVER_getSpiChannel(SPI_HandleTypeDef *_pSpi)
	{
	uint8_t channel = 3;

	if( _pSpi->Instance == ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)) )
		{
		channel = 0;
		}
	else if( _pSpi->Instance == ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)) )
		{
		channel = 1;
		}
	else if( _pSpi->Instance == ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)) )
		{
		channel = 2;
		}
...
tdStatus SPI_DRIVER_initDevice(tdSpiDevice *_pDevice, SPI_HandleTypeDef *_pSpiHandle, tdSpiCS *_pCs)
	...
	if( _pDevice == (void *) 0 || _pSpiHandle == (void *) 0 )
		return Fail;

...
#line 6 "..\\..\\Src\\core\\fileSystem.c"
#line 7 "..\\..\\Src\\core\\fileSystem.c"

uint8_t badBlocksList[ (4096 / 8) ];
...
tdStatus FILE_SYSTEM_satDefaultConfigurationTable(tdConfigurationTable *_pConfigTable)
	...
	{ _pConfigTable ->data[ 0 + 3 ] = ( ((unsigned int)224 >> 24) & 0xFF ); _pConfigTable ->data[ 0 + 2 ] = ( ((unsigned int)224 >> 16) & 0xFF ); _pConfigTable ->data[ 0 + 1 ] = ( ((unsigned int)224 >> 8) & 0xFF ); _pConfigTable ->data[ 0 + 0 ] = ( ((unsigned int)224 >> 0) & 0xFF ); };
	{ _pConfigTable ->data[ 4 + 3 ] = ( ((unsigned int)4096 >> 24) & 0xFF ); _pConfigTable ->data[ 4 + 2 ] = ( ((unsigned int)4096 >> 16) & 0xFF ); _pConfigTable ->data[ 4 + 1 ] = ( ((unsigned int)4096 >> 8) & 0xFF ); _pConfigTable ->data[ 4 + 0 ] = ( ((unsigned int)4096 >> 0) & 0xFF ); };
	{ _pConfigTable ->data[ 8 + 3 ] = ( ((unsigned int)128 >> 24) & 0xFF ); _pConfigTable ->data[ 8 + 2 ] = ( ((unsigned int)128 >> 16) & 0xFF ); _pConfigTable ->data[ 8 + 1 ] = ( ((unsigned int)128 >> 8) & 0xFF ); _pConfigTable ->data[ 8 + 0 ] = ( ((unsigned int)128 >> 0) & 0xFF ); };
	{ _pConfigTable ->data[ 12 + 3 ] = ( ((unsigned int)4096 >> 24) & 0xFF ); _pConfigTable ->data[ 12 + 2 ] = ( ((unsigned int)4096 >> 16) & 0xFF ); _pConfigTable ->data[ 12 + 1 ] = ( ((unsigned int)4096 >> 8) & 0xFF ); _pConfigTable ->data[ 12 + 0 ] = ( ((unsigned int)4096 >> 0) & 0xFF ); };
	{ _pConfigTable ->data[ 16 + 3 ] = ( ((unsigned int)1 >> 24) & 0xFF ); _pConfigTable ->data[ 16 + 2 ] = ( ((unsigned int)1 >> 16) & 0xFF ); _pConfigTable ->data[ 16 + 1 ] = ( ((unsigned int)1 >> 8) & 0xFF ); _pConfigTable ->data[ 16 + 0 ] = ( ((unsigned int)1 >> 0) & 0xFF ); };
	{ _pConfigTable ->data[ 20 + 3 ] = ( ((unsigned int)0 >> 24) & 0xFF ); _pConfigTable ->data[ 20 + 2 ] = ( ((unsigned int)0 >> 16) & 0xFF ); _pConfigTable ->data[ 20 + 1 ] = ( ((unsigned int)0 >> 8) & 0xFF ); _pConfigTable ->data[ 20 + 0 ] = ( ((unsigned int)0 >> 0) & 0xFF ); };
	{ _pConfigTable ->data[ 24 + 3 ] = ( ((unsigned int)_pConfigTable ->SBD >> 24) & 0xFF ); _pConfigTable ->data[ 24 + 2 ] = ( ((unsigned int)_pConfigTable ->SBD >> 16) & 0xFF ); _pConfigTable ->data[ 24 + 1 ] = ( ((unsigned int)_pConfigTable ->SBD >> 8) & 0xFF ); _pConfigTable ->data[ 24 + 0 ] = ( ((unsigned int)_pConfigTable ->SBD >> 0) & 0xFF ); };
	{ _pConfigTable ->data[ 28 + 0 ] = ( (_pConfigTable ->NTD >> 0) & 0xFF ); };
	{ _pConfigTable ->data[ 29 + _pConfigTable ->SBD + 0 ] = ( (0x10 >> 0) & 0xFF ); };
...
tdStatus FILE_SYSTEM_saveConfigurationTable(tdConfigurationTable *_pConfigTable)
	...
	{ sbdBuff[ 0 + 3 ] = ( ((unsigned int)_pConfigTable ->SBD >> 24) & 0xFF ); sbdBuff[ 0 + 2 ] = ( ((unsigned int)_pConfigTable ->SBD >> 16) & 0xFF ); sbdBuff[ 0 + 1 ] = ( ((unsigned int)_pConfigTable ->SBD >> 8) & 0xFF ); sbdBuff[ 0 + 0 ] = ( ((unsigned int)_pConfigTable ->SBD >> 0) & 0xFF ); };

	EEPROM_DRIVER_writeByte(pFileSystemDataRam, 0xFF0, _pConfigTable->exist);
	EEPROM_DRIVER_writeByte(pFileSystemDataRam, 0xFF9, _pConfigTable->NTD );
	EEPROM_DRIVER_writeBuffer(pFileSystemDataRam, 0xFF5, sbdBuff, 4 );
	EEPROM_DRIVER_writeBuffer(pFileSystemDataRam, 0x1000, _pConfigTable->data, _pConfigTable->size );
...
tdStatus FILE_SYSTEM_readConfigurationTable(tdConfigurationTable *_pConfigTable)
	...
	EEPROM_DRIVER_readByte(pFileSystemDataRam, 0xFF0, &exist);

	_pConfigTable->exist = exist;

	if( _pConfigTable->exist == 1 )
		{
		if( EEPROM_DRIVER_readBuffer(pFileSystemDataRam, 0xFF5, sbdBuff, 4 ) != Ok )
			return Fail;

		if( EEPROM_DRIVER_readByte(pFileSystemDataRam, 0xFF9, &NTD ) != Ok )
			return Fail;

		_pConfigTable->SBD = ( ( (sbdBuff[ 0 + 3 ] & 0xFF) << 24) | ( (sbdBuff[ 0 + 2 ] & 0xFF) << 16) | ( (sbdBuff[ 0 + 1 ] & 0xFF) << 8) | ( (sbdBuff[ 0 + 0 ] & 0xFF) << 0) );
		_pConfigTable->NTD = NTD;
		_pConfigTable->size = 29 + _pConfigTable->SBD + _pConfigTable->NTD;

		if( EEPROM_DRIVER_readBuffer(pFileSystemDataRam, 0x1000, _pConfigTable->data, _pConfigTable->size ) != Ok )
			return Fail;
		}
	else
		{
...
tdStatus FILE_SYSTEM_init(tdFat *_pFat)
	{
	SPI_HandleTypeDef *pHspiRam1;
	SPI_HandleTypeDef *pHspiRam2;
	tdSpiCS chipSelectRam1;
	tdSpiCS chipSelectRam2;

	Init_Driver();

#line 201 "..\\..\\Src\\core\\fileSystem.c"
	pHspiRam1 = &hspi1;
	pHspiRam2 = &hspi1;
	chipSelectRam1.pGPIO = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800));
	chipSelectRam1.pin = ((uint16_t)0x0010);
	chipSelectRam2.pGPIO = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800));
	chipSelectRam2.pin = ((uint16_t)0x0020);



	SPI_DRIVER_initDevice(&RAM_1, pHspiRam1, &chipSelectRam1);
	SPI_DRIVER_initDevice(&RAM_2, pHspiRam2, &chipSelectRam2);

	FILE_SYSTEM_setDataRam();

	FILE_SYSTEM_readBadBlocksList();

#line 225 "..\\..\\Src\\core\\fileSystem.c"
...
tdStatus FILE_SYSTEM_clearBadBlocksList(void)
	...
	if( EEPROM_DRIVER_eraseRange(pFileSystemDataRam, 0x0100, 0x0100 + (4096 / 8)) != Ok )
		status = Fail;
	...
	while( block < to )
		...
		if( *pByte != 0 )
			...
			*pByte = 0;
			...
			EEPROM_DRIVER_writeByte(pFileSystemDataRam, 0x0100 + block, 0x00);
...
tdStatus FILE_SYSTEM_readBadBlocksList(void)
	{
	if( EEPROM_DRIVER_readBuffer(pFileSystemDataRam, 0x0100, badBlocksList, (4096 / 8) ) != Ok )
		return Fail;
...
tdStatus FILE_SYSTEM_saveBadBlockStatusToMemmory(tdFileSystemBlock _block, uint8_t _status)
	...
	if( EEPROM_DRIVER_writeByte(pFileSystemDataRam, 0x0100 + byte, *pByte) != Ok )
		return Fail;
...
uint8_t FILE_SYSTEM_isBadBlockAtAddress(tdFileSystemPageAddress _pageAddress)
	{
	return FILE_SYSTEM_isBadBlock( _pageAddress / 128 );
	}

tdStatus FILE_SYSTEM_getSparePageData(const nand_addr_t *_pAddress, tdSparePageData *_pSpareData, uint8_t *_pSparePage)
	{
	if( FILE_SYSTEM_readSparePage(*_pAddress, _pSparePage, 224) == TimeOut )
		return Fail;

	_pSpareData->dataType = ( ( (_pSparePage[ 0 + 0 ] & 0xFF) << 0) );
	_pSpareData->fileNum = ( ( (_pSparePage[ 1 + 3 ] & 0xFF) << 24) | ( (_pSparePage[ 1 + 2 ] & 0xFF) << 16) | ( (_pSparePage[ 1 + 1 ] & 0xFF) << 8) | ( (_pSparePage[ 1 + 0 ] & 0xFF) << 0) );
	_pSpareData->crc8 = ( ( (_pSparePage[ 25 + 0 ] & 0xFF) << 0) );
	_pSpareData->timeStart = ( ( (_pSparePage[ 13 + 3 ] & 0xFF) << 24) | ( (_pSparePage[ 13 + 2 ] & 0xFF) << 16) | ( (_pSparePage[ 13 + 1 ] & 0xFF) << 8) | ( (_pSparePage[ 13 + 0 ] & 0xFF) << 0) );
	_pSpareData->timeEnd = ( ( (_pSparePage[ 17 + 3 ] & 0xFF) << 24) | ( (_pSparePage[ 17 + 2 ] & 0xFF) << 16) | ( (_pSparePage[ 17 + 1 ] & 0xFF) << 8) | ( (_pSparePage[ 17 + 0 ] & 0xFF) << 0) );
...
tdStatus FILE_SYSTEM_createFatTable(tdFat *_pFat)
	...
	_pFat->pFirstFile->pPreviousFile = 0;
	_pFat->pFirstFile->pNextFile = 0;
	...
	do
		...
		if( startsFound == 1 && (spareData.fileNum != pFile->fileNum || natCheckAddress.block == 4096 - 1 || spareData.dataType == 0xFF ) )
			{
			memset(&natTmpAddress, 0x00, sizeof(natTmpAddress));
			natTmpAddress.block = natCheckAddress.block - 1;
			if( (natTmpAddress.block < 4096) == 0 )
				natTmpAddress.block = 0;

			FILE_SYSTEM_getLastPageAddressInBlock(&natTmpAddress, pSparePage);

			pFile->addressEnd = natTmpAddress.block * 128 + natTmpAddress.page;
			...
			pFile->pNextFile = (tdFileNode *)malloc( sizeof(tdFileNode) ); 
			pFile->pNextFile->pPreviousFile = pFile; 
		...
		if( spareData.dataType != 0xFF && spareData.crc8 != 0 )
			...
			if( startsFound == 0 )
				...
				pFile->addressStart = natCheckAddress.block * 128;
			...
			if( spareData.timeStart < timeStart.time )
				...
				timeStart.address = natCheckAddress.block * 128;
				}

			if( spareData.timeEnd > timeEnd.time )
				{
				timeEnd.time = spareData.timeEnd;
				timeEnd.address = natCheckAddress.block * 128;
				}
			}

		} while( ++natCheckAddress.block < 4096 );
	...
	if( _pFat->filesAmount == 1 )
		...
		{
		if( _pFat->pFirstFile != 0 && _pFat->pLastFile != 0 )
			{
...
tdStatus FILE_SYSTEM_clearFatTable(tdFat *_pFat)
	...
	if( _pFat->pFirstFile == 0 )
		return Ok;

	while( _pFat->pFirstFile->pNextFile != 0 )
		{
		pFile = _pFat->pFirstFile;
...
tdStatus FILE_SYSTEM_newFile(tdFat *_pFat)
	...
	if( _pFat->filesAmount == 0 )
		...
		_pFat->pFirstFile->addressStart = 0; 
		}
	else
		{
	...
	attempt = 0;
	while( FILE_SYSTEM_isBadBlockAtAddress(_pFat->pFirstFile->addressStart) == 1 && attempt++ < 4096 )
		{
		FILE_SYSTEM_getNextBlockAddress(&_pFat->pFirstFile->addressStart);
		}
...
tdStatus FILE_SYSTEM_getNextBlockAddress(tdFileSystemPageAddress *_pPageAddress)
	{
	*_pPageAddress = ((*_pPageAddress / 128) + 1) * 128;

	if( ( *_pPageAddress < (4096 * 128) ) == 0 )
		*_pPageAddress = 0; 
...
tdStatus FILE_SYSTEM_getPreviousBlockAddress(tdFileSystemPageAddress *_pPageAddress)
	...
	*_pPageAddress = ((*_pPageAddress / 128) - 1) * 128;
	...
	if( ( *_pPageAddress < (4096 * 128) ) == 0 )
		*_pPageAddress = (((4096 * 128) / 128) - 1) * 128;  
...
tdStatus FILE_SYSTEM_generateNandAddress(nand_addr_t *_pAddress, tdFileSystemPageAddress _pageAddress)
	{
	if( ( _pageAddress < (4096 * 128) ) == 0 )
		return Fail;

	_pAddress->lun = 0; 
	_pAddress->block = _pageAddress / 128;
	_pAddress->page = _pageAddress % 128;
	_pAddress->column = 0; 
...
tdStatus FILE_SYSTEM_writePage(nand_addr_t _address, tdFileSystemData *_pData, int _size)
	{
	if( NAND_Page_Program(_address, _pData, _size) != 0x00 )
		return Fail;
...
tdStatus FILE_SYSTEM_readPage(nand_addr_t _address, tdFileSystemData *_pData, int _size)
	{
	if( NAND_Page_Read(_address, _pData, _size) != 0x00 )
		return Fail;
...
tdStatus FILE_SYSTEM_writeSparePage(nand_addr_t _address, tdFileSystemData *_pData, int _size)
	{
	if( NAND_Spare_Program(_address, _pData, _size) != 0x00 )
		return Fail;
...
tdStatus FILE_SYSTEM_readSparePage(nand_addr_t _address, tdFileSystemData *_pData, int _size)
	{
	if( NAND_Spare_Read(_address, _pData, _size) != 0x00 )
		return Fail;
...
tdStatus FILE_SYSTEM_writeDataToFile(tdFileNode *pFile, tdFileSystemData *_pData, int _dataSize, tdFileSystemData *_pSpare, int _spareSize)
	...
	{ _pSpare[ 1 + 3 ] = ( (pFile ->fileNum >> 24) & 0xFF ); _pSpare[ 1 + 2 ] = ( (pFile ->fileNum >> 16) & 0xFF ); _pSpare[ 1 + 1 ] = ( (pFile ->fileNum >> 8) & 0xFF ); _pSpare[ 1 + 0 ] = ( (pFile ->fileNum >> 0) & 0xFF ); };
	{ _pSpare[ 5 + 3 ] = ( (pFile ->addressStart >> 24) & 0xFF ); _pSpare[ 5 + 2 ] = ( (pFile ->addressStart >> 16) & 0xFF ); _pSpare[ 5 + 1 ] = ( (pFile ->addressStart >> 8) & 0xFF ); _pSpare[ 5 + 0 ] = ( (pFile ->addressStart >> 0) & 0xFF ); };
	{ _pSpare[ 9 + 3 ] = ( (pFile ->filePageAddress >> 24) & 0xFF ); _pSpare[ 9 + 2 ] = ( (pFile ->filePageAddress >> 16) & 0xFF ); _pSpare[ 9 + 1 ] = ( (pFile ->filePageAddress >> 8) & 0xFF ); _pSpare[ 9 + 0 ] = ( (pFile ->filePageAddress >> 0) & 0xFF ); };

	crc8 = CRC8_( _pSpare, 25 - 1 ); 

	{ _pSpare[ 25 + 0 ] = ( (crc8 >> 0) & 0xFF ); };
	...
	pFile->addressEnd++;
	if( (pFile->addressEnd < (4096 * 128)) == 0 )
		pFile->addressEnd = 0; 

...
#line 44 "..\\..\\Drivers\\STM32F2xx_HAL_Driver\\Src\\stm32f2xx_hal_rcc_ex.c"
...
HAL_StatusTypeDef HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef  *PeriphClkInit)
{
  ...
  if(((PeriphClkInit->PeriphClockSelection) & ((uint32_t)0x00000001)) == (((uint32_t)0x00000001)))
  {
    ...
    (*(volatile uint32_t *) (((uint32_t)0x42000000) + (((((((uint32_t)0x40000000) + 0x00020000) + 0x3800) - ((uint32_t)0x40000000)) + 0x00) * 32) + (0x1A * 4)) = DISABLE);    
    ...
    (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->PLLI2SCFGR = ((PeriphClkInit->PLLI2S . PLLI2SN) << (__clz(__rbit(((uint32_t)0x00007FC0))))) | ((PeriphClkInit->PLLI2S . PLLI2SR) << (__clz(__rbit(((uint32_t)0x70000000))))));
    
     
    (*(volatile uint32_t *) (((uint32_t)0x42000000) + (((((((uint32_t)0x40000000) + 0x00020000) + 0x3800) - ((uint32_t)0x40000000)) + 0x00) * 32) + (0x1A * 4)) = ENABLE);
  ...
  if(((PeriphClkInit->PeriphClockSelection) & ((uint32_t)0x00000008)) == (((uint32_t)0x00000008)))
  {
    ...
    if((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->BDCR & ((uint32_t)0x00000300)) != (PeriphClkInit->RTCClockSelection & ((uint32_t)0x00000300)))
    {
      ...
      tmpreg = (((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->BDCR & ~(((uint32_t)0x00000300)));
       
      (*(volatile uint32_t *) (((uint32_t)0x42000000) + (((((((uint32_t)0x40000000) + 0x00020000) + 0x3800) - ((uint32_t)0x40000000)) + 0x70) * 32) + (0x10 * 4)) = ENABLE);
      (*(volatile uint32_t *) (((uint32_t)0x42000000) + (((((((uint32_t)0x40000000) + 0x00020000) + 0x3800) - ((uint32_t)0x40000000)) + 0x70) * 32) + (0x10 * 4)) = DISABLE);
       
      ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->BDCR = tmpreg;
    }
      
     
    if(PeriphClkInit->RTCClockSelection == ((uint32_t)0x00000100))
    {
...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef  *PeriphClkInit)
{
  ...
  PeriphClkInit->PeriphClockSelection = ((uint32_t)0x00000001) | ((uint32_t)0x00000008);

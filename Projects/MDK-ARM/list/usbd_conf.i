...
#line 147 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_core.h"
...
#line 98 "..\\..\\Src\\usbd_conf.c"
void HAL_PCD_MspInit(PCD_HandleTypeDef* hpcd)
	{
	GPIO_InitTypeDef GPIO_InitStruct;

	if( hpcd->Instance == ((USB_OTG_GlobalTypeDef *) ((uint32_t )0x40040000)) )
		{
		...
		GPIO_InitStruct.Pin = ((uint16_t)0x0001) | ((uint16_t)0x0004) | ((uint16_t)0x0008);
		...
		GPIO_InitStruct.Pin = ((uint16_t)0x0001)|((uint16_t)0x0002)|((uint16_t)0x0400)|((uint16_t)0x0800) 
										     |((uint16_t)0x1000)|((uint16_t)0x2000)|((uint16_t)0x0020);
		GPIO_InitStruct.Mode = ((uint32_t)0x00000002);
		GPIO_InitStruct.Pull = ((uint32_t)0x00000000);
		GPIO_InitStruct.Speed = ((uint32_t)0x00000003);
		GPIO_InitStruct.Alternate = ((uint8_t)0xA);
...
void HAL_PCD_MspDeInit(PCD_HandleTypeDef* hpcd)
	...
	if( hpcd->Instance == ((USB_OTG_GlobalTypeDef *) ((uint32_t )0x40040000)) )
		...
		HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((uint16_t)0x0001)|((uint16_t)0x0004)|((uint16_t)0x0008));

		HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0008)|((uint16_t)0x0020));

		HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), ((uint16_t)0x0001)|((uint16_t)0x0002)|((uint16_t)0x0400)|((uint16_t)0x0800) 
											    |((uint16_t)0x1000)|((uint16_t)0x2000)|((uint16_t)0x0020));
...
USBD_StatusTypeDef  USBD_LL_Init (USBD_HandleTypeDef *pdev)
	...
	if( pdev->id == 1 )
		...
		hpcd_USB_OTG_HS.Instance = ((USB_OTG_GlobalTypeDef *) ((uint32_t )0x40040000));
		hpcd_USB_OTG_HS.Init.dev_endpoints = 11;
		hpcd_USB_OTG_HS.Init.dma_enable = ENABLE;
		hpcd_USB_OTG_HS.Init.ep0_mps = 0;





		hpcd_USB_OTG_HS.Init.speed = 0;
		hpcd_USB_OTG_HS.Init.phy_itface = 1;

		HAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0002), GPIO_PIN_SET); 
		...
		HAL_PCD_SetTxFiFo(&hpcd_USB_OTG_HS, 3, 0x174);
		}
	return USBD_OK;
	}

...
uint8_t UserRxBufferHS[512];

 
uint8_t UserTxBufferHS[512];
...
static int8_t CDC_Receive_HS(uint8_t* Buf, uint32_t *Len)
	...
	;
	USB_CORE_requestHandler(Buf, Len);

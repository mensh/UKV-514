...
#line 177 "..\\..\\Src\\main.c"
	...
	RCC_OscInitStruct.HSEState = ((uint8_t)0x01);
	RCC_OscInitStruct.PLL.PLLState = ((uint8_t)0x02);
	RCC_OscInitStruct.PLL.PLLSource = ((uint32_t)0x00400000);
	RCC_OscInitStruct.PLL.PLLM = 8;
	RCC_OscInitStruct.PLL.PLLN = 192;
	RCC_OscInitStruct.PLL.PLLP = ((uint32_t)0x00000002);
	RCC_OscInitStruct.PLL.PLLQ = 4;
	HAL_RCC_OscConfig(&RCC_OscInitStruct);

	RCC_ClkInitStruct.ClockType = ((uint32_t)0x00000001)|((uint32_t)0x00000004)
															|((uint32_t)0x00000008);
	RCC_ClkInitStruct.SYSCLKSource = ((uint32_t)0x00000002);
	RCC_ClkInitStruct.AHBCLKDivider = ((uint32_t)0x00000000);
	RCC_ClkInitStruct.APB1CLKDivider = ((uint32_t)0x00001400);
	RCC_ClkInitStruct.APB2CLKDivider = ((uint32_t)0x00001000);
	HAL_RCC_ClockConfig(&RCC_ClkInitStruct, ((uint32_t)0x00000003));

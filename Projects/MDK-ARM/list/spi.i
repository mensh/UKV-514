...
void MX_SPI1_Init(void)
	{
	hspi1.Instance = ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000));
	hspi1.Init.Mode = (((uint32_t)0x00000004) | ((uint32_t)0x00000100));
	hspi1.Init.Direction = ((uint32_t)0x00000000);
	hspi1.Init.DataSize = ((uint32_t)0x00000000);
	hspi1.Init.CLKPolarity = ((uint32_t)0x00000000);
	hspi1.Init.CLKPhase = ((uint32_t)0x00000000);
	hspi1.Init.NSS = ((uint32_t)0x00000200);
	hspi1.Init.BaudRatePrescaler = ((uint32_t)0x00000010);
	hspi1.Init.FirstBit = ((uint32_t)0x00000000);
	hspi1.Init.TIMode = ((uint32_t)0x00000000);
	hspi1.Init.CRCCalculation = ((uint32_t)0x00000000);
	HAL_SPI_Init(&hspi1);
	}
...
void MX_SPI3_Init(void)
	{
	hspi3.Instance = ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00));
	hspi3.Init.Mode = (((uint32_t)0x00000004) | ((uint32_t)0x00000100));
	hspi3.Init.Direction = ((uint32_t)0x00000000);
	hspi3.Init.DataSize = ((uint32_t)0x00000000);
	hspi3.Init.CLKPolarity = ((uint32_t)0x00000000);
	hspi3.Init.CLKPhase = ((uint32_t)0x00000000);
	hspi3.Init.NSS = ((uint32_t)0x00000200);
	hspi3.Init.BaudRatePrescaler = ((uint32_t)0x00000010);
	hspi3.Init.FirstBit = ((uint32_t)0x00000000);
	hspi3.Init.TIMode = ((uint32_t)0x00000000);
	hspi3.Init.CRCCalculation = ((uint32_t)0x00000000);
	HAL_SPI_Init(&hspi3);
	}
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
	...
	if( hspi->Instance == ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)) )
		{
...
#line 110 "..\\..\\Src\\spi.c"
    ...
    GPIO_InitStruct.Speed = ((uint32_t)0x00000000);
    ...
    HAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), &GPIO_InitStruct);
		...
		hdma_spi1_rx.Instance = ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x040));
		hdma_spi1_rx.Init.Channel = ((uint32_t)0x06000000);
		hdma_spi1_rx.Init.Direction = ((uint32_t)0x00000000);
		hdma_spi1_rx.Init.PeriphInc = ((uint32_t)0x00000000);
		hdma_spi1_rx.Init.MemInc = ((uint32_t)((uint32_t)0x00000400));
		hdma_spi1_rx.Init.PeriphDataAlignment = ((uint32_t)0x00000000);
		hdma_spi1_rx.Init.MemDataAlignment = ((uint32_t)0x00000000);
		hdma_spi1_rx.Init.Mode = ((uint32_t)0x00000000);
		hdma_spi1_rx.Init.Priority = ((uint32_t)((uint32_t)0x00030000));
		hdma_spi1_rx.Init.MemBurst = ((uint32_t)0x00000000);
		hdma_spi1_rx.Init.FIFOMode = ((uint32_t)0x00000000);
		hdma_spi1_rx.Init.PeriphBurst = ((uint32_t)0x00000000);
		HAL_DMA_Init(&hdma_spi1_rx);

		do{ (hspi)->hdmarx = &(hdma_spi1_rx); (hdma_spi1_rx). Parent = (hspi); } while(0);

		hdma_spi1_tx.Instance = ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x058));
		hdma_spi1_tx.Init.Channel = ((uint32_t)0x06000000);
		hdma_spi1_tx.Init.Direction = ((uint32_t)((uint32_t)0x00000040));
		hdma_spi1_tx.Init.PeriphInc = ((uint32_t)0x00000000);
		hdma_spi1_tx.Init.MemInc = ((uint32_t)((uint32_t)0x00000400));
		...
		hdma_spi1_tx.Init.Priority = ((uint32_t)((uint32_t)0x00030000));
		hdma_spi1_tx.Init.FIFOMode = ((uint32_t)0x00000000);
		hdma_spi1_tx.Init.MemBurst = ((uint32_t)0x00000000);
		hdma_spi1_tx.Init.PeriphBurst = ((uint32_t)0x00000000);
	...
	else if( hspi->Instance == ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3C00)) )
		{
		...
		hdma_spi3_rx.Instance = ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x010));
		hdma_spi3_rx.Init.Channel = ((uint32_t)0x00000000);
		hdma_spi3_rx.Init.Direction = ((uint32_t)0x00000000);
		hdma_spi3_rx.Init.PeriphInc = ((uint32_t)0x00000000);
		hdma_spi3_rx.Init.MemInc = ((uint32_t)((uint32_t)0x00000400));
		hdma_spi3_rx.Init.PeriphDataAlignment = ((uint32_t)0x00000000);
		hdma_spi3_rx.Init.MemDataAlignment = ((uint32_t)0x00000000);
		hdma_spi3_rx.Init.Mode = ((uint32_t)0x00000000);
		hdma_spi3_rx.Init.Priority = ((uint32_t)((uint32_t)0x00030000));
		hdma_spi3_rx.Init.FIFOMode = ((uint32_t)0x00000000);
		HAL_DMA_Init(&hdma_spi3_rx);

		do{ (hspi)->hdmarx = &(hdma_spi3_rx); (hdma_spi3_rx). Parent = (hspi); } while(0);

		hdma_spi3_tx.Instance = ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6000) + 0x088));
		hdma_spi3_tx.Init.Channel = ((uint32_t)0x00000000);
		hdma_spi3_tx.Init.Direction = ((uint32_t)((uint32_t)0x00000040));
		hdma_spi3_tx.Init.PeriphInc = ((uint32_t)0x00000000);
		hdma_spi3_tx.Init.MemInc = ((uint32_t)((uint32_t)0x00000400));
		hdma_spi3_tx.Init.PeriphDataAlignment = ((uint32_t)0x00000000);
		hdma_spi3_tx.Init.MemDataAlignment = ((uint32_t)0x00000000);
		hdma_spi3_tx.Init.Mode = ((uint32_t)0x00000000);
		hdma_spi3_tx.Init.Priority = ((uint32_t)((uint32_t)0x00030000));
		hdma_spi3_tx.Init.FIFOMode = ((uint32_t)0x00000000);
...
#line 237 "..\\..\\Src\\spi.c"
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0040)|((uint16_t)0x0080));
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), ((uint16_t)0x0008));
		...
		HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), ((uint16_t)0x0400)|((uint16_t)0x0800)|((uint16_t)0x1000));

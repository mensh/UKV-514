...
void MX_CAN1_Init(void)
{
  ...
  hcan1.Instance = ((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400));
  hcan1.Init.Prescaler = 16;
  hcan1.Init.Mode = ((uint32_t)0x00000000);
  hcan1.Init.SJW = ((uint32_t)0x00000000);
  hcan1.Init.BS1 = ((uint32_t)0x00000000);
  hcan1.Init.BS2 = ((uint32_t)0x00000000);
...
void HAL_CAN_MspInit(CAN_HandleTypeDef* hcan)
{
  ...
  if(hcan->Instance==((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)))
  {
...
void HAL_CAN_MspDeInit(CAN_HandleTypeDef* hcan)
{
  ...
  if(hcan->Instance==((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), ((uint16_t)0x0100)|((uint16_t)0x0200));

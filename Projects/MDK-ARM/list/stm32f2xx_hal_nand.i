...
#line 87 "..\\..\\Drivers\\STM32F2xx_HAL_Driver\\Src\\stm32f2xx_hal_nand.c"
...
HAL_StatusTypeDef  HAL_NAND_Init(NAND_HandleTypeDef *hnand, FSMC_NAND_PCC_TimingTypeDef *ComSpace_Timing, FSMC_NAND_PCC_TimingTypeDef *AttSpace_Timing)
{
  ...
  (((hnand->Init . NandBank) == ((uint32_t)0x00000010))? ((hnand->Instance)->PCR2 |= ((uint32_t)0x00000004)): ((hnand->Instance)->PCR3 |= ((uint32_t)0x00000004)));
...
HAL_StatusTypeDef HAL_NAND_DeInit(NAND_HandleTypeDef *hnand)  
{
  ...
  do{ (hnand)->Lock = HAL_UNLOCKED; }while (0);
...
void HAL_NAND_IRQHandler(NAND_HandleTypeDef *hnand)
{
  ...
  if((((hnand->Init . NandBank) == ((uint32_t)0x00000010))? (((hnand->Instance)->SR2 &(((uint32_t)0x00000001))) == (((uint32_t)0x00000001))): (((hnand->Instance)->SR3 &(((uint32_t)0x00000001))) == (((uint32_t)0x00000001)))))
  {
     
    HAL_NAND_ITCallback(hnand);
  
     
    (((hnand->Init . NandBank) == ((uint32_t)0x00000010))? ((hnand->Instance)->SR2 &= ~(((uint32_t)0x00000001))): ((hnand->Instance)->SR3 &= ~(((uint32_t)0x00000001))));
  }
  
   
  if((((hnand->Init . NandBank) == ((uint32_t)0x00000010))? (((hnand->Instance)->SR2 &(((uint32_t)0x00000002))) == (((uint32_t)0x00000002))): (((hnand->Instance)->SR3 &(((uint32_t)0x00000002))) == (((uint32_t)0x00000002)))))
  {
     
    HAL_NAND_ITCallback(hnand);
  
     
    (((hnand->Init . NandBank) == ((uint32_t)0x00000010))? ((hnand->Instance)->SR2 &= ~(((uint32_t)0x00000002))): ((hnand->Instance)->SR3 &= ~(((uint32_t)0x00000002))));
  }

   
  if((((hnand->Init . NandBank) == ((uint32_t)0x00000010))? (((hnand->Instance)->SR2 &(((uint32_t)0x00000004))) == (((uint32_t)0x00000004))): (((hnand->Instance)->SR3 &(((uint32_t)0x00000004))) == (((uint32_t)0x00000004)))))
  {
     
    HAL_NAND_ITCallback(hnand);
  
     
    (((hnand->Init . NandBank) == ((uint32_t)0x00000010))? ((hnand->Instance)->SR2 &= ~(((uint32_t)0x00000004))): ((hnand->Instance)->SR3 &= ~(((uint32_t)0x00000004))));
  }
  
   
  if((((hnand->Init . NandBank) == ((uint32_t)0x00000010))? (((hnand->Instance)->SR2 &(((uint32_t)0x00000040))) == (((uint32_t)0x00000040))): (((hnand->Instance)->SR3 &(((uint32_t)0x00000040))) == (((uint32_t)0x00000040)))))
  {
     
    HAL_NAND_ITCallback(hnand);
  
     
    (((hnand->Init . NandBank) == ((uint32_t)0x00000010))? ((hnand->Instance)->SR2 &= ~(((uint32_t)0x00000040))): ((hnand->Instance)->SR3 &= ~(((uint32_t)0x00000040))));
  }  
...
HAL_StatusTypeDef HAL_NAND_Read_ID(NAND_HandleTypeDef *hnand, NAND_IDTypeDef *pNAND_ID)
{
  ...
  do{ if((hnand)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hnand)->Lock = HAL_LOCKED; } }while (0);  
  ...
  if(hnand->Init.NandBank == ((uint32_t)0x00000010))
  {
    deviceAddress = ((uint32_t)0x70000000);
  }
  else
  {
    deviceAddress = ((uint32_t)0x80000000);
  }
  ...
  *(volatile uint8_t *)((uint32_t)(deviceAddress | ((uint32_t)(1<<16))))  = 0x90;
  *(volatile uint8_t *)((uint32_t)(deviceAddress | ((uint32_t)(1<<17)))) = 0x00;

   	
  data = *(volatile uint32_t *)deviceAddress;
  
   
  pNAND_ID->Maker_Id   = (uint8_t)((data)& 0xFF);
  pNAND_ID->Device_Id  = (uint8_t)(((data)& 0xFF00) >> 8);
  pNAND_ID->Third_Id   = (uint8_t)(((data)& 0xFF0000) >> 16);
  pNAND_ID->Fourth_Id  = (uint8_t)(((data)& 0xFF000000) >> 24);
...
HAL_StatusTypeDef HAL_NAND_Reset(NAND_HandleTypeDef *hnand)
{
  ...
  *(volatile uint8_t *)((uint32_t)(deviceAddress | ((uint32_t)(1<<16)))) = 0xFF;
...
{   
  ...
  nandAddress = ((pAddress)->Page + (((pAddress)->Block + (((pAddress)->Zone) * ((hnand)->Info . BlockSize)))* ((hnand)->Info . ZoneSize)));
  ...
  {	   
    ...
    *(volatile uint8_t *)((uint32_t)(deviceAddress | ((uint32_t)(1<<16)))) = ((uint8_t)0x00);  
   
    *(volatile uint8_t *)((uint32_t)(deviceAddress | ((uint32_t)(1<<17)))) = 0x00; 
    *(volatile uint8_t *)((uint32_t)(deviceAddress | ((uint32_t)(1<<17)))) = (uint8_t)((nandAddress)& 0xFF); 
    *(volatile uint8_t *)((uint32_t)(deviceAddress | ((uint32_t)(1<<17)))) = (uint8_t)(((nandAddress)& 0xFF00) >> 8); 
    *(volatile uint8_t *)((uint32_t)(deviceAddress | ((uint32_t)(1<<17)))) = (uint8_t)(((nandAddress)& 0xFF0000) >> 16);
  
         
    if(hnand->Info.BlockNbr >= 1024)
    {
      *(volatile uint8_t *)((uint32_t)(deviceAddress | ((uint32_t)(1<<17)))) = (uint8_t)(((nandAddress)& 0xFF000000) >> 24);
    }
  
    *(volatile uint8_t *)((uint32_t)(deviceAddress | ((uint32_t)(1<<16))))  = 0x30;
...
HAL_StatusTypeDef HAL_NAND_Write_Page(NAND_HandleTypeDef *hnand, NAND_AddressTypedef *pAddress, uint8_t *pBuffer, uint32_t NumPageToWrite)
{
  ...
  {  
    ...
    *(volatile uint8_t *)((uint32_t)(deviceAddress | ((uint32_t)(1<<16)))) = ((uint8_t)0x00);
    *(volatile uint8_t *)((uint32_t)(deviceAddress | ((uint32_t)(1<<16)))) = 0x80;
    ...
    *(volatile uint8_t *)((uint32_t)(deviceAddress | ((uint32_t)(1<<16)))) = 0x10;
    
     
    while(HAL_NAND_Read_Status(hnand) != ((uint32_t)0x00000040))
    {
       
      timeout = HAL_GetTick() + ((uint32_t)0x01000000);
...
HAL_StatusTypeDef HAL_NAND_Read_SpareArea(NAND_HandleTypeDef *hnand, NAND_AddressTypedef *pAddress, uint8_t *pBuffer, uint32_t NumSpareAreaToRead)
{
  ...
  {     
    ...
    *(volatile uint8_t *)((uint32_t)(deviceAddress | ((uint32_t)(1<<16)))) = ((uint8_t)0x50);
...
HAL_StatusTypeDef HAL_NAND_Erase_Block(NAND_HandleTypeDef *hnand, NAND_AddressTypedef *pAddress)
{
  ...
  *(volatile uint8_t *)((uint32_t)(DeviceAddress | ((uint32_t)(1<<16)))) = 0x60;

  *(volatile uint8_t *)((uint32_t)(DeviceAddress | ((uint32_t)(1<<17)))) = (uint8_t)((((pAddress)->Page + (((pAddress)->Block + (((pAddress)->Zone) * ((hnand)->Info . BlockSize)))* ((hnand)->Info . ZoneSize))))& 0xFF);
  *(volatile uint8_t *)((uint32_t)(DeviceAddress | ((uint32_t)(1<<17)))) = (uint8_t)(((((pAddress)->Page + (((pAddress)->Block + (((pAddress)->Zone) * ((hnand)->Info . BlockSize)))* ((hnand)->Info . ZoneSize))))& 0xFF00) >> 8);
  *(volatile uint8_t *)((uint32_t)(DeviceAddress | ((uint32_t)(1<<17)))) = (uint8_t)(((((pAddress)->Page + (((pAddress)->Block + (((pAddress)->Zone) * ((hnand)->Info . BlockSize)))* ((hnand)->Info . ZoneSize))))& 0xFF0000) >> 16);
  
        
  if(hnand->Info.BlockNbr >= 1024)
  {
    *(volatile uint8_t *)((uint32_t)(DeviceAddress | ((uint32_t)(1<<17)))) = (uint8_t)(((((pAddress)->Page + (((pAddress)->Block + (((pAddress)->Zone) * ((hnand)->Info . BlockSize)))* ((hnand)->Info . ZoneSize))))& 0xFF000000) >> 24);
  }  
		
  *(volatile uint8_t *)((uint32_t)(DeviceAddress | ((uint32_t)(1<<16)))) = 0xD0; 
...
uint32_t HAL_NAND_Read_Status(NAND_HandleTypeDef *hnand)
{
  ...
  *(volatile uint8_t *)((uint32_t)(DeviceAddress | ((uint32_t)(1<<16)))) = 0x70;
  
   
  data = *(volatile uint8_t *)DeviceAddress;

   
  if((data & ((uint32_t)0x00000001)) == ((uint32_t)0x00000001))
  {
    return ((uint32_t)0x00000001);
  } 
  else if((data & ((uint32_t)0x00000040)) == ((uint32_t)0x00000040))
  {
...
uint32_t HAL_NAND_Address_Inc(NAND_HandleTypeDef *hnand, NAND_AddressTypedef *pAddress)
{
  uint32_t status = ((uint32_t)0x00000100);

...
#line 55 "..\\..\\Drivers\\STM32F2xx_HAL_Driver\\Src\\stm32f2xx_hal.c"
...
#line 78 "..\\..\\Drivers\\STM32F2xx_HAL_Driver\\Src\\stm32f2xx_hal.c"
...
HAL_StatusTypeDef HAL_Init(void)
{
  ...
  HAL_SYSTICK_Config(((uint32_t)16000000)/ 1000);
...
void HAL_EnableCompensationCell(void)
{
  *(volatile uint32_t *)(((uint32_t)0x42000000) + (((((((uint32_t)0x40000000) + 0x00010000) + 0x3800) - ((uint32_t)0x40000000)) + 0x20) * 32) + (((uint8_t)0x00) * 4)) = (uint32_t)ENABLE;
}
...
void HAL_DisableCompensationCell(void)
{
  *(volatile uint32_t *)(((uint32_t)0x42000000) + (((((((uint32_t)0x40000000) + 0x00010000) + 0x3800) - ((uint32_t)0x40000000)) + 0x20) * 32) + (((uint8_t)0x00) * 4)) = (uint32_t)DISABLE;
}

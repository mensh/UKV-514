...
#line 45 "..\\..\\Drivers\\STM32F2xx_HAL_Driver\\Src\\stm32f2xx_hal_pwr.c"
...
void HAL_PWR_EnableBkUpAccess(void)
{
  *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x00) * 32) + (0x08 * 4)) = (uint32_t)ENABLE;
}
...
void HAL_PWR_DisableBkUpAccess(void)
{
  *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x00) * 32) + (0x08 * 4)) = (uint32_t)DISABLE;
}
...
void HAL_PWR_PVDConfig(PWR_PVDTypeDef *sConfigPVD)
{
  ...
  tmpreg &= ~ (uint32_t)((uint32_t)0x000000E0);
  ...
  if((sConfigPVD->Mode == ((uint32_t)0x00000003)) ||     (sConfigPVD->Mode == ((uint32_t)0x00000002)) ||     (sConfigPVD->Mode == ((uint32_t)0x00000001))) 


  {
    (((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->IMR |= (((uint32_t)0x00010000)));
  }
   
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->RTSR &= ~((uint32_t)0x00010000);
  ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->FTSR &= ~((uint32_t)0x00010000);  
   
  if((sConfigPVD->Mode == ((uint32_t)0x00000003)) ||     (sConfigPVD->Mode == ((uint32_t)0x00000001)))

  {
    ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->RTSR |= ((uint32_t)0x00010000);
  }
   
  if((sConfigPVD->Mode == ((uint32_t)0x00000003)) ||     (sConfigPVD->Mode == ((uint32_t)0x00000002)))
...
void HAL_PWR_EnablePVD(void)
{
  *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x00) * 32) + (0x04 * 4)) = (uint32_t)ENABLE;
}
...
void HAL_PWR_DisablePVD(void)
{
  *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x00) * 32) + (0x04 * 4)) = (uint32_t)DISABLE;
}
...
void HAL_PWR_EnableWakeUpPin(uint32_t WakeUpPinx)
{
  ...
  ((void)0);
  *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x04) * 32) + (0x08 * 4)) = (uint32_t)ENABLE;
}
...
void HAL_PWR_DisableWakeUpPin(uint32_t WakeUpPinx)
{
  ...
  ((void)0);  
  *(volatile uint32_t *) (((uint32_t)0x42000000) + ((((((uint32_t)0x40000000) + 0x7000) - ((uint32_t)0x40000000)) + 0x04) * 32) + (0x08 * 4)) = (uint32_t)DISABLE;
}
...
void HAL_PWR_EnterSLEEPMode(uint32_t Regulator, uint8_t SLEEPEntry)
{
  ...
  ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL  &= 0xFE;
...
void HAL_PWR_PVD_IRQHandler(void)
{
  ...
  if((((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->PR & (((uint32_t)0x00010000))) != RESET)
  {
     
    HAL_PWR_PVDCallback();
    
     
    (((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->PR = (((uint32_t)0x00010000)));
  }
}

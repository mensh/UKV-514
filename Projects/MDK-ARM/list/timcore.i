...
void MX_TIM2_Init(void)
	...
	sConfigOC.OCMode = (((uint32_t)0x00000020) | ((uint32_t)0x00000040));
	sConfigOC.Pulse = 1;
	sConfigOC.OCPolarity = ((uint32_t)0x0000);
	sConfigOC.OCFastMode = ((uint32_t)0x0000);
	HAL_TIM_PWM_ConfigChannel(&htim2, &sConfigOC, ((uint32_t)0x0008));
...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef* htim_pwm)
	...
	if( htim_pwm->Instance == ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)) )
		{
...
void TIM_CORE_initTim2(void)
	...
	MX_TIM2_Init();
	HAL_TIM_PWM_Start(&htim2, ((uint32_t)0x0008));
	}
...
void MX_TIM7_Init(void)
	{
	TIM_MasterConfigTypeDef sMasterConfig;
	htim7.Instance = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1400));
	htim7.Init.Period = 60000; 
	htim7.Init.Prescaler = 0;
	htim7.Init.ClockDivision = 0;
	htim7.Init.CounterMode = ((uint32_t)0x0000);
	HAL_TIM_Base_Init(&htim7);

	sMasterConfig.MasterOutputTrigger = (((uint32_t)0x00000020));
	sMasterConfig.MasterSlaveMode = ((uint32_t)0x0000);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef *htim_base)
	{
	if( htim_base->Instance == ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1400)) )
		{
...
void (*TIM_CORE_tim7Callback)(void) = (void *) 0;
...
void TIM_CORE_setCallback(TIM_HandleTypeDef *htim, void (*pCallback)(void))
	{
	if( htim->Instance == ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1400)) )
		{
		TIM_CORE_tim7Callback = pCallback;
		}
	}
...
void TIM_CORE_getCallback(TIM_HandleTypeDef *htim, void (**_pCallback)() )
	...
	if( htim->Instance == ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1400)) )
		{
		*_pCallback = TIM_CORE_tim7Callback;
		}
	else
		{
		*_pCallback = (void *) 0;
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim)
	...
	if( htim->Instance == ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1400)) )
		{
		if( TIM_CORE_tim7Callback != (void *) 0 )
			{

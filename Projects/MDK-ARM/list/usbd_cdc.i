...
#line 68 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Class\\CDC\\Src\\usbd_cdc.c"
#line 1 "..\\..\\Inc\\usbd_desc.h"
...
#line 69 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Class\\CDC\\Src\\usbd_cdc.c"
#line 70 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Class\\CDC\\Src\\usbd_cdc.c"
...
#line 71 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Class\\CDC\\Src\\usbd_cdc.c"
...
__align(4) static uint8_t USBD_CDC_DeviceQualifierDesc[0x0A]  =
{
  0x0A,
  6,
  0x00,
...
__align(4) uint8_t USBD_CDC_CfgHSDesc[51]  =
{
...
__align(4) uint8_t USBD_CDC_CfgFSDesc[51]  =
{
...
__align(4) uint8_t USBD_CDC_OtherSpeedCfgDesc[51]  =
{
...
uint8_t USBD_CDC_isTxState(USBD_HandleTypeDef *pdev)
	{
...
{ 
  ...
  if((pdev->pUserData != 0) && (hcdc->CmdOpCode != 0xFF))
  {
...
#line 676 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Class\\CDC\\Src\\usbd_cdc.c"
...
uint8_t  USBD_CDC_TransmitPacket(USBD_HandleTypeDef *pdev)
	...
	if( hcdc->TxState == 0 )
		...
		USBD_LL_Transmit(pdev, 0x83, hcdc->TxBuffer, hcdc->TxLength);

...
#line 77 "..\\..\\Drivers\\STM32F2xx_HAL_Driver\\Src\\stm32f2xx_hal_pcd.c"
...
void HAL_PCD_IRQHandler(PCD_HandleTypeDef *hpcd)
	...
	if( USB_GetMode(hpcd->Instance) == 0 )
		{
		 
		if( (USB_ReadInterrupts((hpcd)->Instance) == 0) ) 
			{
			return;
			}

		if( ((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00000002))) == (((uint32_t)0x00000002))) )
			{
			 
			(((hpcd)->Instance ->GINTSTS) |= (((uint32_t)0x00000002)));
			}

		if( ((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00080000))) == (((uint32_t)0x00080000))) )
			{
			epnum = 0;
			...
			while( ep_intr )
				...
				if( ep_intr & 0x1 )
					...
					if( (epint & ((uint32_t)0x00000001)) == ((uint32_t)0x00000001) )
						{
						(((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00) + (epnum)*((uint32_t )0x20)))->DOEPINT = (((uint32_t)0x00000001)));

						ep = &hpcd->OUT_ep[ epnum ];

						if( hpcd->Init.dma_enable == 1 )
							{
							ep->xfer_count = ep->maxpacket - (((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00) + (epnum)*((uint32_t )0x20)))->DOEPTSIZ & ((uint32_t)0x0007FFFF)); 
					...
					if( (epint & ((uint32_t)0x00000008)) == ((uint32_t)0x00000008) )
						{
						 
						HAL_PCD_SetupStageCallback(hpcd);
						(((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00) + (epnum)*((uint32_t )0x20)))->DOEPINT = (((uint32_t)0x00000008)));
						}

					if( (epint & ((uint32_t)0x00000010)) == ((uint32_t)0x00000010) )
						{
						(((USB_OTG_OUTEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0xB00) + (epnum)*((uint32_t )0x20)))->DOEPINT = (((uint32_t)0x00000010)));
						}
					}
				epnum++;
				ep_intr >>= 1;
		...
		if( ((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00040000))) == (((uint32_t)0x00040000))) )
			{
			...
			while( ep_intr )
				...
				if( ep_intr & 0x1 )  
					...
					if( (epint & ((uint32_t)0x00000001)) == ((uint32_t)0x00000001) )
						...
						((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800)))->DIEPEMPMSK &= ~fifoemptymsk;

						(((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900) + (epnum)*((uint32_t )0x20)))->DIEPINT = (((uint32_t)0x00000001)));
					...
					if( (epint & ((uint32_t)0x00000008)) == ((uint32_t)0x00000008) )
						{
						(((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900) + (epnum)*((uint32_t )0x20)))->DIEPINT = (((uint32_t)0x00000008)));
						}
						
					if( (epint & ((uint32_t)0x00000010)) == ((uint32_t)0x00000010) )
						{					
						(((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900) + (epnum)*((uint32_t )0x20)))->DIEPINT = (((uint32_t)0x00000010)));
						}
						
					if( (epint & ((uint32_t)0x00000040)) == ((uint32_t)0x00000040) )
						{
						(((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900) + (epnum)*((uint32_t )0x20)))->DIEPINT = (((uint32_t)0x00000040)));
						}
						
					if( (epint & ((uint32_t)0x00000002)) == ((uint32_t)0x00000002) )
						{
						(((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900) + (epnum)*((uint32_t )0x20)))->DIEPINT = (((uint32_t)0x00000002)));
						} 
						
					if( (epint & ((uint32_t)0x00000080)) == ((uint32_t)0x00000080) )
						{
		...
		if( ((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x80000000))) == (((uint32_t)0x80000000))) )
			{    
			 
			((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800)))->DCTL &= ~((uint32_t)0x00000001);

			HAL_PCD_ResumeCallback(hpcd);

			(((hpcd)->Instance ->GINTSTS) |= (((uint32_t)0x80000000)));
			}

		 
		if( ((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00000800))) == (((uint32_t)0x00000800))) )
			{
			if( (((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800)))->DSTS & ((uint32_t)0x00000001)) == ((uint32_t)0x00000001) )
				{ 
				HAL_PCD_SuspendCallback(hpcd);
				}
			(((hpcd)->Instance ->GINTSTS) |= (((uint32_t)0x00000800)));
			}

		 
		if( ((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00001000))) == (((uint32_t)0x00001000))) )
			{
			((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800)))->DCTL &= ~((uint32_t)0x00000001); 
			...
			((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800)))->DAINTMSK |= 0x10001;

			if( hpcd->Init.use_dedicated_ep1 )
				{
				((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800)))->DOUTEP1MSK |= (((uint32_t)0x00000008) | ((uint32_t)0x00000001) | ((uint32_t)0x00000002)); 
				((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800)))->DINEP1MSK |= (((uint32_t)0x00000008) | ((uint32_t)0x00000001) | ((uint32_t)0x00000002));  
				}
			else
				{
				((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800)))->DOEPMSK |= (((uint32_t)0x00000008) | ((uint32_t)0x00000001) | ((uint32_t)0x00000002));
				((USB_OTG_DeviceTypeDef *)((uint32_t )USBx + ((uint32_t )0x800)))->DIEPMSK |= (((uint32_t)0x00000008) | ((uint32_t)0x00000001) | ((uint32_t)0x00000002));
				}
			...
			(((hpcd)->Instance ->GINTSTS) |= (((uint32_t)0x00001000)));
			}

		 
		if( ((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00002000))) == (((uint32_t)0x00002000))) )
			{
			USB_ActivateSetup(hpcd->Instance);
			hpcd->Instance->GUSBCFG &= ~((uint32_t)0x00003C00);

			if( USB_GetDevSpeed(hpcd->Instance) == 0 )
				{
				hpcd->Init.speed            = 0;
				hpcd->Init.ep0_mps          = 512 ;    
				hpcd->Instance->GUSBCFG |= (((uint32_t)0x00000400) | ((uint32_t)0x00002000));
				}
			else
				{
				hpcd->Init.speed            = 3;
				hpcd->Init.ep0_mps          = 64 ;  
				hpcd->Instance->GUSBCFG |= (((uint32_t)0x00000400) | ((uint32_t)0x00001000));
				}

			HAL_PCD_ResetCallback(hpcd);

			(((hpcd)->Instance ->GINTSTS) |= (((uint32_t)0x00002000)));
			}


		 
		if(((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00000010))) == (((uint32_t)0x00000010))))
			{
			((hpcd->Instance)->GINTMSK &= ~(((uint32_t)0x00000010)));
			temp = USBx->GRXSTSP;
			ep = &hpcd->OUT_ep[ temp & ((uint32_t)0x0000000F) ];

			if( ((temp & ((uint32_t)0x001E0000)) >> 17) ==  2 )
				{
				if( (temp & ((uint32_t)0x00007FF0)) != 0 )
					{
					USB_ReadPacket(USBx, ep->xfer_buff, (temp & ((uint32_t)0x00007FF0)) >> 4);
					ep->xfer_buff += (temp & ((uint32_t)0x00007FF0)) >> 4;
					ep->xfer_count += (temp & ((uint32_t)0x00007FF0)) >> 4;
					}
				}
		...
		if( ((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00000008))) == (((uint32_t)0x00000008))) )
			{
			HAL_PCD_SOFCallback(hpcd);
			(((hpcd)->Instance ->GINTSTS) |= (((uint32_t)0x00000008)));
			}

		 
		if( ((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00100000))) == (((uint32_t)0x00100000))) )
			{
			HAL_PCD_ISOINIncompleteCallback(hpcd, epnum);
			(((hpcd)->Instance ->GINTSTS) |= (((uint32_t)0x00100000)));
			} 

		 
		if( ((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00200000))) == (((uint32_t)0x00200000))) )
			{
			HAL_PCD_ISOOUTIncompleteCallback(hpcd, epnum);
			(((hpcd)->Instance ->GINTSTS) |= (((uint32_t)0x00200000)));
			} 

		 
		if( ((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x40000000))) == (((uint32_t)0x40000000))) )
			{
			HAL_PCD_ConnectCallback(hpcd);
			(((hpcd)->Instance ->GINTSTS) |= (((uint32_t)0x40000000)));
			} 

		 
		if( ((USB_ReadInterrupts((hpcd)->Instance) & (((uint32_t)0x00000004))) == (((uint32_t)0x00000004))) )
			{
			temp = hpcd->Instance->GOTGINT;

			if( (temp & ((uint32_t)0x00000004)) == ((uint32_t)0x00000004) )
				{
...
static HAL_StatusTypeDef PCD_WriteEmptyTxFifo(PCD_HandleTypeDef *hpcd, uint32_t epnum)
{
  ...
  while  ( (((USB_OTG_INEndpointTypeDef *)((uint32_t)USBx + ((uint32_t )0x900) + (epnum)*((uint32_t )0x20)))->DTXFSTS & ((uint32_t)0x0000FFFF)) > len32b &&

...
void MX_DMA_Init(void)
{
  ...
  hdma_memtomem_dma2_stream0.Instance = ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x010));
  hdma_memtomem_dma2_stream0.Init.Channel = ((uint32_t)0x00000000);
  hdma_memtomem_dma2_stream0.Init.Direction = ((uint32_t)((uint32_t)0x00000080));
  hdma_memtomem_dma2_stream0.Init.PeriphInc = ((uint32_t)0x00000000);
  hdma_memtomem_dma2_stream0.Init.MemInc = ((uint32_t)0x00000000);
  hdma_memtomem_dma2_stream0.Init.PeriphDataAlignment = ((uint32_t)0x00000000);
  hdma_memtomem_dma2_stream0.Init.MemDataAlignment = ((uint32_t)0x00000000);
  hdma_memtomem_dma2_stream0.Init.Mode = ((uint32_t)0x00000000);
  hdma_memtomem_dma2_stream0.Init.Priority = ((uint32_t)((uint32_t)0x00020000));
  hdma_memtomem_dma2_stream0.Init.FIFOMode = ((uint32_t)((uint32_t)0x00000004));
  hdma_memtomem_dma2_stream0.Init.FIFOThreshold = ((uint32_t)0x00000000);
  hdma_memtomem_dma2_stream0.Init.MemBurst = ((uint32_t)0x00000000);
  hdma_memtomem_dma2_stream0.Init.PeriphBurst = ((uint32_t)0x00000000);
  HAL_DMA_Init(&hdma_memtomem_dma2_stream0);

   
  hdma_memtomem_dma2_stream1.Instance = ((DMA_Stream_TypeDef *) (((((uint32_t)0x40000000) + 0x00020000) + 0x6400) + 0x028));
  hdma_memtomem_dma2_stream1.Init.Channel = ((uint32_t)0x00000000);
  hdma_memtomem_dma2_stream1.Init.Direction = ((uint32_t)((uint32_t)0x00000080));
  hdma_memtomem_dma2_stream1.Init.PeriphInc = ((uint32_t)0x00000000);
  hdma_memtomem_dma2_stream1.Init.MemInc = ((uint32_t)0x00000000);
  hdma_memtomem_dma2_stream1.Init.PeriphDataAlignment = ((uint32_t)0x00000000);
  hdma_memtomem_dma2_stream1.Init.MemDataAlignment = ((uint32_t)0x00000000);
  hdma_memtomem_dma2_stream1.Init.Mode = ((uint32_t)0x00000000);
  hdma_memtomem_dma2_stream1.Init.Priority = ((uint32_t)((uint32_t)0x00020000));
  hdma_memtomem_dma2_stream1.Init.FIFOMode = ((uint32_t)((uint32_t)0x00000004));
  hdma_memtomem_dma2_stream1.Init.FIFOThreshold = ((uint32_t)0x00000000);
  hdma_memtomem_dma2_stream1.Init.MemBurst = ((uint32_t)0x00000000);
  hdma_memtomem_dma2_stream1.Init.PeriphBurst = ((uint32_t)0x00000000);

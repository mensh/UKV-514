...
#line 60 "..\\..\\Drivers\\STM32F2xx_HAL_Driver\\Src\\stm32f2xx_ll_usb.c"
...
HAL_StatusTypeDef USB_DevInit (USB_OTG_GlobalTypeDef *USBx, USB_OTG_CfgTypeDef cfg)
{
  ...
  USBx->GCCFG |= ((uint32_t)0x00080000);
...
HAL_StatusTypeDef USB_FlushTxFifo (USB_OTG_GlobalTypeDef *USBx, uint32_t num )
{
  ...
  USBx->GRSTCTL = ( ((uint32_t)0x00000020) |(uint32_t)( num << 5 )); 
...
HAL_StatusTypeDef USB_HostInit (USB_OTG_GlobalTypeDef *USBx, USB_OTG_CfgTypeDef cfg)
{
  ...
  *(volatile uint32_t *)((uint32_t)USBx + ((uint32_t )0xE00)) = 0;
  ...
  USBx->GCCFG &=~ (((uint32_t)0x00040000));
  USBx->GCCFG &=~ (((uint32_t)0x00080000));
  USBx->GCCFG |= ((uint32_t)0x00200000);
...
#line 1365 "..\\..\\Drivers\\STM32F2xx_HAL_Driver\\Src\\stm32f2xx_ll_usb.c"
...
HAL_StatusTypeDef USB_HC_StartXfer(USB_OTG_GlobalTypeDef *USBx, USB_OTG_HCTypeDef *hc, uint8_t dma)
{
  ...
  ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500) + (hc->ch_num)*((uint32_t )0x20)))->HCCHAR &= ~((uint32_t)0x40000000);
  ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500) + (hc->ch_num)*((uint32_t )0x20)))->HCCHAR |= ((uint32_t)0x80000000);
  ...
  {  
    if((hc->ep_is_in == 0) && (hc->xfer_len > 0))
    {
      ...
      case 1:
        ...
        if(len_words > (((USB_OTG_HostTypeDef *)((uint32_t )USBx + ((uint32_t )0x400)))->HPTXSTS & 0xFFFF))  
        {
...
HAL_StatusTypeDef USB_DoPing(USB_OTG_GlobalTypeDef *USBx , uint8_t ch_num)
{
  ...
  ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500) + (ch_num)*((uint32_t )0x20)))->HCCHAR &= ~((uint32_t)0x40000000);
  ((USB_OTG_HostChannelTypeDef *)((uint32_t)USBx + ((uint32_t )0x500) + (ch_num)*((uint32_t )0x20)))->HCCHAR |= ((uint32_t)0x80000000);

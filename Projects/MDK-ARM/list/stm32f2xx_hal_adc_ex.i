...
#line 119 "..\\..\\Drivers\\STM32F2xx_HAL_Driver\\Src\\stm32f2xx_hal_adc_ex.c"
...
HAL_StatusTypeDef HAL_ADCEx_InjectedStart(ADC_HandleTypeDef* hadc)
{
  ...
  {
    tmp1 = (((hadc->Instance ->CR2) & (((uint32_t)0x00300000))) == RESET);
    tmp2 = (((hadc->Instance ->CR1) & (((uint32_t)0x00000400))) == RESET);
    if(tmp1 && tmp2)
    {
       
      hadc->Instance->CR2 |= ((uint32_t)0x00400000);
    }
  }
  else
  {
    tmp1 = (((hadc->Instance ->CR2) & (((uint32_t)0x00300000))) == RESET);
    tmp2 = (((hadc->Instance ->CR1) & (((uint32_t)0x00000400))) == RESET);
    if((hadc->Instance == ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000))) && tmp1 && tmp2)  
    {
...
HAL_StatusTypeDef HAL_ADCEx_InjectedPollForConversion(ADC_HandleTypeDef* hadc, uint32_t Timeout)
{
  ...
  while(!(((((hadc)->Instance ->SR) & (((uint32_t)((uint32_t)0x00000004)))) == (((uint32_t)((uint32_t)0x00000004))))))
  {
...
HAL_StatusTypeDef HAL_ADCEx_MultiModeStart_DMA(ADC_HandleTypeDef* hadc, uint32_t* pData, uint32_t Length)
{
  ...
  if (hadc->Init.DMAContinuousRequests != DISABLE)
  {
    ...
    ((ADC_Common_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2300))->CCR |= ((uint32_t)0x00002000);
  }
  else
  {
  ...
  HAL_DMA_Start_IT(hadc->DMA_Handle, (uint32_t)&((ADC_Common_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2300))->CDR, (uint32_t)pData, Length);
...
uint32_t HAL_ADCEx_MultiModeGetValue(ADC_HandleTypeDef* hadc)
{
  ...
  return ((ADC_Common_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2300))->CDR;
}
...
HAL_StatusTypeDef HAL_ADCEx_InjectedConfigChannel(ADC_HandleTypeDef* hadc, ADC_InjectionConfTypeDef* sConfigInjected)
{
  ...
  if (sConfigInjected->InjectedChannel > ((uint32_t)(((uint32_t)0x00000008) | ((uint32_t)0x00000001))))
  {
     
    hadc->Instance->SMPR1 &= ~((((uint32_t)0x00000007)) << (3 * ((sConfigInjected->InjectedChannel) - 10)));
    
     
    hadc->Instance->SMPR1 |= ((sConfigInjected->InjectedSamplingTime) << (3 * ((sConfigInjected->InjectedChannel) - 10)));
  }
  else  
  {
     
    hadc->Instance->SMPR2 &= ~((((uint32_t)0x00000007)) << (3 * (sConfigInjected->InjectedChannel)));
    
     
    hadc->Instance->SMPR2 |= ((sConfigInjected->InjectedSamplingTime) << (3 * (sConfigInjected->InjectedChannel)));
  }
  
   
  hadc->Instance->JSQR &= ~(((uint32_t)0x00300000));
  hadc->Instance->JSQR |=  (((sConfigInjected->InjectedNbrOfConversion) - (uint8_t)1) << 20);
  
   
  
   
  hadc->Instance->JSQR &= ~((((uint32_t)0x0000001F)) << (5 * (uint8_t)(((sConfigInjected->InjectedRank) + 3) - (sConfigInjected->InjectedNbrOfConversion))));
   
   
  hadc->Instance->JSQR |= ((sConfigInjected->InjectedChannel) << (5 * (uint8_t)(((sConfigInjected->InjectedRank) + 3) - (sConfigInjected->InjectedNbrOfConversion))));

   
  hadc->Instance->CR2 &= ~(((uint32_t)0x000F0000));
  hadc->Instance->CR2 |=  sConfigInjected->ExternalTrigInjecConv;
  
   
  hadc->Instance->CR2 &= ~(((uint32_t)0x00300000));
  hadc->Instance->CR2 |= sConfigInjected->ExternalTrigInjecConvEdge;
  
  if (sConfigInjected->AutoInjectedConv != DISABLE)
  {
     
    hadc->Instance->CR1 |= ((uint32_t)0x00000400);
  }
  else
  {
  ...
  if (sConfigInjected->InjectedDiscontinuousConvMode != DISABLE)
  {
    ...
    hadc->Instance->CR1 |= ((uint32_t)0x00001000);
  }
  else
  {
  ...
  switch(sConfigInjected->InjectedRank)
  {
    case 1:
      ...
      hadc->Instance->JOFR1 &= ~(((uint32_t)0x00000FFF));
      hadc->Instance->JOFR1 |= sConfigInjected->InjectedOffset;
      break;
    case 2:
       
      hadc->Instance->JOFR2 &= ~(((uint32_t)0x00000FFF));
      hadc->Instance->JOFR2 |= sConfigInjected->InjectedOffset;
      break;
    case 3:
       
      hadc->Instance->JOFR3 &= ~(((uint32_t)0x00000FFF));
      hadc->Instance->JOFR3 |= sConfigInjected->InjectedOffset;
      break;
    default:
       
      hadc->Instance->JOFR4 &= ~(((uint32_t)0x00000FFF));
      hadc->Instance->JOFR4 |= sConfigInjected->InjectedOffset;
      break;
  }
  
   
  if ((hadc->Instance == ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000))) && (sConfigInjected->InjectedChannel == ((uint32_t)((uint32_t)(((uint32_t)0x00000010) | ((uint32_t)0x00000002))))))
  {
  ...
  if ((hadc->Instance == ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2000))) && ((sConfigInjected->InjectedChannel == ((uint32_t)((uint32_t)((uint32_t)0x00000010)))) || (sConfigInjected->InjectedChannel == ((uint32_t)((uint32_t)(((uint32_t)0x00000010) | ((uint32_t)0x00000001)))))))
  {
...
HAL_StatusTypeDef HAL_ADCEx_MultiModeConfigChannel(ADC_HandleTypeDef* hadc, ADC_MultiModeTypeDef* multimode)
{
  ...
  ((ADC_Common_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2300))->CCR &= ~(((uint32_t)0x0000001F));
  ((ADC_Common_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2300))->CCR |= multimode->Mode;
  
   
  ((ADC_Common_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2300))->CCR &= ~(((uint32_t)0x0000C000));
  ((ADC_Common_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2300))->CCR |= multimode->DMAAccessMode;
  
   
  ((ADC_Common_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2300))->CCR &= ~(((uint32_t)0x00000F00));
  ((ADC_Common_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x2300))->CCR |= multimode->TwoSamplingDelay;

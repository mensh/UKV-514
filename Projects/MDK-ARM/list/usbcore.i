...
#line 16 "..\\..\\Inc\\usbCore.h"
#line 1 "..\\..\\Inc\\fileSystem.h"
...
#line 1 "..\\..\\Inc\\manipulationsWithNumbers.h"
...
#line 64 "..\\..\\Inc\\manipulationsWithNumbers.h"
...
#line 78 "..\\..\\Inc\\manipulationsWithNumbers.h"
...
#line 102 "..\\..\\Inc\\manipulationsWithNumbers.h"
...
#line 16 "..\\..\\Inc\\fileSystem.h"
#line 1 "..\\..\\Inc\\tdStatus.h"



typedef enum { Busy = 0, Ok = 1, Fail = 2, TimeOut = 3, ProcessBreak = 4 } tdStatus;
typedef enum { ARINC429 = 0x10 } tdEnumDataType;

#line 17 "..\\..\\Inc\\fileSystem.h"
#line 1 "..\\..\\Inc\\nand_MT29F_lld.h"
...
extern MT_uint8 Init_Driver(void);
extern NAND_HandleTypeDef nandHandle;
extern NAND_HandleTypeDef nandHandle1;
 
extern MT_uint8 NAND_Reset(void);

 
extern MT_uint8 NAND_Read_ID(flash_width *buf);
extern MT_uint8 NAND_Read_ID_ONFI(flash_width *buf);
extern MT_uint8 NAND_Read_Param_Page(param_page_t *ppage);

 
extern MT_uint8 NAND_Get_Feature(flash_width feature_address, flash_width *subfeature);
extern MT_uint8 NAND_Set_Feature(flash_width feature_address, flash_width subfeature);

 
extern flash_width NAND_Read_Status(void);
extern flash_width NAND_Read_Status_Enhanced(nand_addr_t addr);

 
extern MT_uint8 NAND_Page_Read(nand_addr_t addr, flash_width *buffer, MT_uint32 lenght);
extern MT_uint8 NAND_Spare_Read(nand_addr_t addr, flash_width *buffer, MT_uint32 lenght);

 
extern MT_uint8 NAND_Block_Erase(nand_addr_t addr);

 
extern MT_uint8 NAND_Page_Program(nand_addr_t addr, flash_width *buffer, MT_uint32 lenght);
extern MT_uint8 NAND_Spare_Program(nand_addr_t addr, flash_width *buffer, MT_uint32 lenght);

 
extern MT_uint8 NAND_Copy_Back(nand_addr_t src_addr, nand_addr_t dest_addr);

 
extern MT_uint8 NAND_Lock(void);
extern MT_uint8 NAND_Unlock(nand_addr_t start_block, nand_addr_t end_block);
extern MT_uint8 NAND_Read_Lock_Status(nand_addr_t block_addr);
...
extern MT_uint8 NAND_Cache_Read(void);
extern MT_uint8 NAND_Cache_Program(void);

 
extern MT_uint8 NAND_Multiplane_Copy_Back(void);
extern MT_uint8 NAND_Multiplane_Page_Program(void);
extern MT_uint8 NAND_Multiplane_Block_Erase(void);

 
extern MT_uint8 NAND_Lock_Down(void);
extern MT_uint8 NAND_Unlock_Down(void);

extern MT_uint8 NAND_OTP_Mode_Enter(void);
extern MT_uint8 NAND_OTP_Page_Program(nand_addr_t addr, flash_width *buffer, MT_uint32 lenght);
extern MT_uint8 NAND_OTP_Page_Read(nand_addr_t addr, flash_width *buffer, MT_uint32 lenght);
extern MT_uint8 NAND_OTP_Mode_Protect(nand_addr_t addr);
extern void DWT_Init(void) ;
#line 18 "..\\..\\Inc\\fileSystem.h"
#line 19 "..\\..\\Inc\\fileSystem.h"
#line 1 "..\\..\\Inc\\holtCore.h"
...
#line 16 "..\\..\\Inc\\holtCore.h"
#line 17 "..\\..\\Inc\\holtCore.h"
#line 1 "..\\..\\Inc\\holtDriver.h"
...
#line 16 "..\\..\\Inc\\holtDriver.h"
#line 17 "..\\..\\Inc\\holtDriver.h"
#line 1 "..\\..\\Inc\\spiDriver.h"
...
#line 17 "..\\..\\Inc\\spiDriver.h"
#line 18 "..\\..\\Inc\\spiDriver.h"
#line 19 "..\\..\\Inc\\spiDriver.h"
#line 20 "..\\..\\Inc\\spiDriver.h"
...
#line 18 "..\\..\\Inc\\holtDriver.h"
#line 1 "..\\..\\Inc\\bhd2settings.h"
...
#line 55 "..\\..\\Inc\\holtDriver.h"

#line 76 "..\\..\\Inc\\holtDriver.h"
...
typedef struct
	...
	tdArincChannel channel[ 8 ];
	uint8_t reversedLabels[ 256 ];
...
#line 54 "..\\..\\Inc\\fileSystem.h"

#line 63 "..\\..\\Inc\\fileSystem.h"




#line 75 "..\\..\\Inc\\fileSystem.h"
...
#line 2 "..\\..\\Src\\core\\usbCore.c"
#line 1 "..\\..\\Inc\\usbd_cdc_if.h"
...
#line 41 "..\\..\\Inc\\usbd_conf.h"
#line 42 "..\\..\\Inc\\usbd_conf.h"
#line 43 "..\\..\\Inc\\usbd_conf.h"
#line 1 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_def.h"
...
#line 311 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_def.h"
...
#line 97 "..\\..\\Inc\\usbd_conf.h"


#line 107 "..\\..\\Inc\\usbd_conf.h"


#line 116 "..\\..\\Inc\\usbd_conf.h"
...
#line 35 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_def.h"
...
#line 62 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_def.h"

#line 69 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_def.h"
...
#line 91 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_def.h"

#line 99 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_def.h"
...
#line 128 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_def.h"
...
#line 270 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_def.h"



     

#line 288 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_def.h"
...
#line 35 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_ioreq.h"
...
#line 34 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_core.h"
#line 35 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_core.h"
#line 1 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_ioreq.h"
...
#line 113 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_ioreq.h"
...
#line 36 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_core.h"
...
#line 35 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_ctlreq.h"
...
#line 37 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_core.h"
...
#line 36 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Core\\Inc\\usbd_ioreq.h"
...
#line 34 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Class\\CDC\\Inc\\usbd_cdc.h"
...
#line 77 "..\\..\\Middlewares\\ST\\STM32_USB_Device_Library\\Class\\CDC\\Inc\\usbd_cdc.h"
...
#line 5 "..\\..\\Src\\core\\usbCore.c"
#line 6 "..\\..\\Src\\core\\usbCore.c"
#line 1 "..\\..\\Inc\\stm32DebugPrint.h"
...
#line 73 "..\\..\\Inc\\stm32DebugPrint.h"



#line 7 "..\\..\\Src\\core\\usbCore.c"
#line 8 "..\\..\\Src\\core\\usbCore.c"
#line 1 "..\\..\\Inc\\core.h"
...
void USB_CORE_0x01(uint8_t* _buf, uint32_t *_len)
	...
	*(pPacket->data +  0 ) = 0x01;
	...
	{ pPacket->data[ 1 + 1 ] = ( (0x010A >> 8) & 0xFF ); pPacket->data[ 1 + 0 ] = ( (0x010A >> 0) & 0xFF ); };
	{ pPacket->data[ 3 + 1 ] = ( (0x0001 >> 8) & 0xFF ); pPacket->data[ 3 + 0 ] = ( (0x0001 >> 0) & 0xFF ); };
...
void USB_CORE_0x04(uint8_t* _buf, uint32_t *_len)
	...
	*(pPacket->data + (528 - 16) +  0 ) = 0x04;
	*(pPacket->data + (528 - 16) +  1 ) = 0;
	*(pPacket->data + (528 - 16) + 14 ) = 0;
	*(pPacket->data + (528 - 16) + 15 ) = *(pPacket->data + (528 - 16) + 14 ) ? 1 : 0;
...
void USB_CORE_0x05(uint8_t* _buf, uint32_t *_len)
	...
	*(pPacket->data + (((4096 / 8) + 16) - 16) +  0 ) = 0x05;

	*(pPacket->data + (((4096 / 8) + 16) - 16) + 15 ) = *(pPacket->data + (((4096 / 8) + 16) - 16) + 14 ) ? 1 : 0;

	pPacket->size = ((4096 / 8) + 16);
	}
...
void USB_CORE_ErasePage(tdData *_pPacket)
	...
	{ _pPacket->data[ 0 + 0 ] = ( (0x07 >> 0) & 0xFF ); };
	{ _pPacket->data[ 1 + 3 ] = ( (packetManeger . packet . currentPacket >> 24) & 0xFF ); _pPacket->data[ 1 + 2 ] = ( (packetManeger . packet . currentPacket >> 16) & 0xFF ); _pPacket->data[ 1 + 1 ] = ( (packetManeger . packet . currentPacket >> 8) & 0xFF ); _pPacket->data[ 1 + 0 ] = ( (packetManeger . packet . currentPacket >> 0) & 0xFF ); };
	...
	{ _pPacket->data[ 15 + 0 ] = ( (status >> 0) & 0xFF ); };
	_pPacket->size = 16;
	};
...
void USB_CORE_0x08(uint8_t* _buf, uint32_t *_len)
	...
	*(pPacket->data + 0 +  0 ) = 0x08;
	*(pPacket->data + 0 + 14 ) = 0;
	*(pPacket->data + 0 + 15 ) = *(pPacket->data + 0 + 14 ) ? 1 : 0;
...
void USB_CORE_FillSmdPacket(tdData *_pPacket)
	{
	FILE_SYSTEM_readPage_( packetManeger.packet.currentPacket, _pPacket->data, 4096);

	{ _pPacket->data[ 4096 + 0 + 0 ] = ( (0x09 >> 0) & 0xFF ); };
	{ _pPacket->data[ 4096 + 1 + 3 ] = ( (packetManeger . packet . currentPacket >> 24) & 0xFF ); _pPacket->data[ 4096 + 1 + 2 ] = ( (packetManeger . packet . currentPacket >> 16) & 0xFF ); _pPacket->data[ 4096 + 1 + 1 ] = ( (packetManeger . packet . currentPacket >> 8) & 0xFF ); _pPacket->data[ 4096 + 1 + 0 ] = ( (packetManeger . packet . currentPacket >> 0) & 0xFF ); };


	*(_pPacket->data + 4096 + 14 ) = 0; 
	*(_pPacket->data + 4096 + 15 ) = *(_pPacket->data + 4096 + 14 ) ? 1 : 0;

	_pPacket->size = (4096 + 16);
	};
...
void USB_CORE_0x09(uint8_t* _buf, uint32_t *_len)
	...
	startPage = ( ( (_buf[ 1 + 3 ] & 0xFF) << 24) | ( (_buf[ 1 + 2 ] & 0xFF) << 16) | ( (_buf[ 1 + 1 ] & 0xFF) << 8) | ( (_buf[ 1 + 0 ] & 0xFF) << 0) );
	endPage = ( ( (_buf[ 5 + 3 ] & 0xFF) << 24) | ( (_buf[ 5 + 2 ] & 0xFF) << 16) | ( (_buf[ 5 + 1 ] & 0xFF) << 8) | ( (_buf[ 5 + 0 ] & 0xFF) << 0) );

	packetManeger.pDataFactory = USB_CORE_FillSmdPacket;
	packetManeger.packet.packetsToSent = 1 + endPage - startPage; 
...
void USB_CORE_0x1A(uint8_t* _buf, uint32_t *_len)
	...
	SBD = ( ( (_buf[ 25 + 3 ] & 0xFF) << 24) | ( (_buf[ 25 + 2 ] & 0xFF) << 16) | ( (_buf[ 25 + 1 ] & 0xFF) << 8) | ( (_buf[ 25 + 0 ] & 0xFF) << 0) );
	NTD = ( ( (_buf[ 29 + 0 ] & 0xFF) << 0) );

	len = 30 + SBD + NTD;

	crc8 = CRC8_( _buf + 1, len - 1);
	crcNotMatches = crc8 != *(_buf + len);
	...
	*(pPacket->data + 0 +  0 ) = 0x27;
	*(pPacket->data + 0 +  1 ) = crc8;
	*(pPacket->data + 0 + 14 ) = crcNotMatches;
	*(pPacket->data + 0 + 15 ) = *(pPacket->data + 0 + 14 ) ? 1 : 0;
...
void USB_CORE_FillConfigurationTable(tdData *_pPacket)
	...
	if( packetManeger.packet.currentPacket == 0 )
		...
		*(_pPacket->data + 1 ) = 0x5A;
		...
		{ _pPacket->data[ 2 + 3 ] = ( (configurationTable . SBD >> 24) & 0xFF ); _pPacket->data[ 2 + 2 ] = ( (configurationTable . SBD >> 16) & 0xFF ); _pPacket->data[ 2 + 1 ] = ( (configurationTable . SBD >> 8) & 0xFF ); _pPacket->data[ 2 + 0 ] = ( (configurationTable . SBD >> 0) & 0xFF ); };
		{ _pPacket->data[ 6 + 0 ] = ( (configurationTable . NTD >> 0) & 0xFF ); };
		...
		*(_pPacket->data + 0 ) = 0x28;
		...
		pByteFrom = configurationTable.data;
		while( byte < configurationTable.size )
			{
			*pByteTo++ = *pByteFrom++;
			byte++;
		...
		{ _pPacket->data[ lenS + configurationTable . size + 0 ] = ( (crc8 >> 0) & 0xFF ); };

		*(_pPacket->data + lenS + configurationTable.size + 1 ) = 0x00; 
		*(_pPacket->data + lenS + configurationTable.size + 2 ) = *(_pPacket->data + lenS + configurationTable.size + 1 ) ? 1 : 0;

		_pPacket->size	= lenS + configurationTable.size + 3;
		}
	}
...
void USB_CORE_0x1C(uint8_t* _buf, uint32_t *_len)
	...
	*(pPacket->data + 0 +  0 ) = 0x29;

	*(pPacket->data + 0 + 14 ) = status;
	*(pPacket->data + 0 + 15 ) = *(pPacket->data + 0 + 14 ) ? 1 : 0;
...
void USB_CORE_FillDataTypes(tdData *_pPacket)
	...
	if( packetManeger.packet.currentPacket == 0 )
		...
		*(_pPacket->data + 1 ) = 0x5A;
		...
		{ _pPacket->data[ 2 + 3 ] = ( (STD >> 24) & 0xFF ); _pPacket->data[ 2 + 2 ] = ( (STD >> 16) & 0xFF ); _pPacket->data[ 2 + 1 ] = ( (STD >> 8) & 0xFF ); _pPacket->data[ 2 + 0 ] = ( (STD >> 0) & 0xFF ); };
...
void USB_CORE_FillFatPacket(tdData *_pPacket)
	...
	if( FAT.filesAmount && pCurrentFile != 0 )
		{
		byteShift = 0;
		for( slot = 0; slot < 16; slot++ )
			{
			{ _pPacket->data[ byteShift + 0 + 3 ] = ( (pCurrentFile ->fileNum >> 24) & 0xFF ); _pPacket->data[ byteShift + 0 + 2 ] = ( (pCurrentFile ->fileNum >> 16) & 0xFF ); _pPacket->data[ byteShift + 0 + 1 ] = ( (pCurrentFile ->fileNum >> 8) & 0xFF ); _pPacket->data[ byteShift + 0 + 0 ] = ( (pCurrentFile ->fileNum >> 0) & 0xFF ); };
			{ _pPacket->data[ byteShift + 4 + 3 ] = ( (pCurrentFile ->addressStart >> 24) & 0xFF ); _pPacket->data[ byteShift + 4 + 2 ] = ( (pCurrentFile ->addressStart >> 16) & 0xFF ); _pPacket->data[ byteShift + 4 + 1 ] = ( (pCurrentFile ->addressStart >> 8) & 0xFF ); _pPacket->data[ byteShift + 4 + 0 ] = ( (pCurrentFile ->addressStart >> 0) & 0xFF ); };
			{ _pPacket->data[ byteShift + 8 + 3 ] = ( (pCurrentFile ->addressEnd >> 24) & 0xFF ); _pPacket->data[ byteShift + 8 + 2 ] = ( (pCurrentFile ->addressEnd >> 16) & 0xFF ); _pPacket->data[ byteShift + 8 + 1 ] = ( (pCurrentFile ->addressEnd >> 8) & 0xFF ); _pPacket->data[ byteShift + 8 + 0 ] = ( (pCurrentFile ->addressEnd >> 0) & 0xFF ); };

			if( pCurrentFile == FAT.pLastFile ) 
				{
				transmitionEnd = 1;
				break;
				}
	...
	{ _pPacket->data[ 192 + 0 + 0 ] = ( (0x2B >> 0) & 0xFF ); };

	if( (pCurrentFile == FAT.pLastFile && transmitionEnd == 1) || pCurrentFile == 0 )
		{
		
		{ _pPacket->data[ 192 + 1 + 0 ] = ( (0x00 >> 0) & 0xFF ); };
		
		{ _pPacket->data[ 192 + 2 + 0 ] = ( (slot >> 0) & 0xFF ); };
		}
	else
		{
		{ _pPacket->data[ 192 + 1 + 0 ] = ( (0x01 >> 0) & 0xFF ); };
		{ _pPacket->data[ 192 + 2 + 0 ] = ( (0x00 >> 0) & 0xFF ); };
		}
...
void USB_CORE_0x1E(uint8_t* _buf, uint32_t *_len)
	...
	if( FAT.filesAmount )
		...
		packetsToSent = (FAT.filesAmount / 16) + ((FAT.filesAmount % 16) ? 1 : 0);
		}
	else
		{
		pCurrentFile = 0;
...
void USB_CORE_FillSsdPacket(tdData *_pPacket)
	{
	FILE_SYSTEM_readSparePage_( packetManeger.packet.currentPacket, _pPacket->data, 224);

	{ _pPacket->data[ 224 + 0 + 0 ] = ( (0x2C >> 0) & 0xFF ); };
	{ _pPacket->data[ 224 + 1 + 3 ] = ( (packetManeger . packet . currentPacket >> 24) & 0xFF ); _pPacket->data[ 224 + 1 + 2 ] = ( (packetManeger . packet . currentPacket >> 16) & 0xFF ); _pPacket->data[ 224 + 1 + 1 ] = ( (packetManeger . packet . currentPacket >> 8) & 0xFF ); _pPacket->data[ 224 + 1 + 0 ] = ( (packetManeger . packet . currentPacket >> 0) & 0xFF ); };

	_pPacket->size = (224 + 16);
	};
...
void USB_CORE_FillSsd(tdData *_pPacket)
	...
	if( pagesNeededToRead < ( 4096 / 224 ) )
		pagesToRead = pagesNeededToRead;
	else
		pagesToRead = ( 4096 / 224 );

	pData = _pPacket->data;
	for( page = 0; page < pagesToRead; page++ )
		{
		FILE_SYSTEM_readSparePage_( packetManeger.packet.currentPage, pData, 224);
	...
	{ _pPacket->data[ ( ( 4096 / 224 ) * 224 ) + 0 + 0 ] = ( (0x2D >> 0) & 0xFF ); };
	{ _pPacket->data[ ( ( 4096 / 224 ) * 224 ) + 1 + 3 ] = ( ((packetManeger . packet . currentPage - 1) >> 24) & 0xFF ); _pPacket->data[ ( ( 4096 / 224 ) * 224 ) + 1 + 2 ] = ( ((packetManeger . packet . currentPage - 1) >> 16) & 0xFF ); _pPacket->data[ ( ( 4096 / 224 ) * 224 ) + 1 + 1 ] = ( ((packetManeger . packet . currentPage - 1) >> 8) & 0xFF ); _pPacket->data[ ( ( 4096 / 224 ) * 224 ) + 1 + 0 ] = ( ((packetManeger . packet . currentPage - 1) >> 0) & 0xFF ); };

	*(_pPacket->data + ( ( 4096 / 224 ) * 224 ) + 14 ) = 0;
	*(_pPacket->data + ( ( 4096 / 224 ) * 224 ) + 15 ) = *(_pPacket->data + ( ( 4096 / 224 ) * 224 ) + 14 ) ? 1 : 0;

	_pPacket->size = ( ( ( 4096 / 224 ) * 224 ) + 16 );
	};
...
void USB_CORE_0x20(uint8_t* _buf, uint32_t *_len)
	...
	packetManeger.packet.packetsToSent = pagesToSent / ( 4096 / 224 );

	if( pagesToSent % ( 4096 / 224 ) != 0 )
		packetManeger.packet.packetsToSent += 1;
...
void USB_CORE_0xFE(uint8_t* _buf, uint32_t *_len)
	{
	tdData *pPacket = &packetManeger.packet.packet[ (packetManeger.packet.pen - 1) % 4 ];

	if( pPacket->size > 3 ) 
		{
		*( pPacket->data + (pPacket->size - 3) ) = 1;	
		}
...
void USB_CORE_clearAllPackets(void)
	{
	memset( &packetManeger.packet.packet, 0x00, (4096 + 16) * 4 );
	}

void USB_CORE_getPacketToPrepare(tdData **_pPacket)
	{
	*_pPacket = &packetManeger.packet.packet[ packetManeger.packet.pen % 4 ];
	}

void USB_CORE_getPacketToSent(tdData **_pPacket)
	{
	*_pPacket = &packetManeger.packet.packet[ packetManeger.packet.eye % 4 ];
	}
...
void USB_CORE_prepareNextPacket(void)
	...
	if( packetManeger.pDataFactory != 0 )
		{
		USB_CORE_getPacketToPrepare( &pPacket );
...
void USB_CORE_requestHandler(uint8_t *_buf, uint32_t *_len)
	...
	if( handler.settings.usbSetLowPriority == 1 )
		{
		packetManeger.usbSetHighPriority = 1;
		HAL_NVIC_SetPriority(OTG_HS_IRQn, 3, 3);
		}

	if( handler.settings.clearPacket == 1 )
		{
	...
	if( handler.settings.preparePacket == 1 )
		{
		USB_CORE_prepareNextPacket();
		}

	if( handler.settings.sendPacket == 1 )
		{
		USB_CORE_sendPacket();
		}
...
void USB_CORE_init(void)
	...
	settings.clearPacket = 1;
	settings.preparePacket = 0;
	settings.sendPacket = 1;
	settings.usbSetLowPriority = 0;
	...
	settings.clearPacket = 0;
	settings.preparePacket = 0;
	settings.sendPacket = 0;
	settings.usbSetLowPriority = 0;

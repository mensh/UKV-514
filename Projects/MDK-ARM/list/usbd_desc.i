...
#line 39 "..\\..\\Src\\usbd_desc.c"
#line 40 "..\\..\\Src\\usbd_desc.c"
...
__align(4) uint8_t USBD_HS_DeviceDesc[0x12]  =
...

 {
    ...
    0x00,                       
    64,           
    ((uint8_t)(24386 & 0x00FF)),           
    ((uint8_t)((24386 & 0xFF00) >>8)),           
    ((uint8_t)(21842 & 0x00FF)),        
    ((uint8_t)((21842 & 0xFF00) >>8)),        
    0x00,                       
    0x02,
     0,            
     0,        
...
__align(4) uint8_t USBD_LangIDDesc[0x04]  =
{
     0x04,
     3,
     ((uint8_t)(1033 & 0x00FF)),
...
__align(4) uint8_t USBD_StrDesc[512] ;
...
uint8_t *  USBD_HS_ProductStrDescriptor( USBD_SpeedTypeDef speed , uint16_t *length)
{
  ...
  if(speed == 0)
  {
    USBD_GetString ((uint8_t *)"Hello World", USBD_StrDesc, length);
  }
  else
  {
    USBD_GetString ((uint8_t *)"Hello World", USBD_StrDesc, length);
...
{
	;
  USBD_GetString ((uint8_t *)"Self made", USBD_StrDesc, length);
  return USBD_StrDesc;
}
...
uint8_t *  USBD_HS_ConfigStrDescriptor( USBD_SpeedTypeDef speed , uint16_t *length)
{
  ...
  if(speed  == USBD_SPEED_HIGH)
  {
    USBD_GetString ((uint8_t *)"CDC Config or not", USBD_StrDesc, length);
  }
  else
  {
    USBD_GetString ((uint8_t *)"CDC Config or not", USBD_StrDesc, length);
...
uint8_t *  USBD_HS_InterfaceStrDescriptor( USBD_SpeedTypeDef speed , uint16_t *length)
{
  ...
  if(speed == 0)
  {
    USBD_GetString ((uint8_t *)"CDC Interface or not", USBD_StrDesc, length);
  }
  else
  {
    USBD_GetString ((uint8_t *)"CDC Interface or not", USBD_StrDesc, length);
